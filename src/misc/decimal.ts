...
function expandNumberExponent(value: number): string {
...
function decimalSource(value: any): string {
...
export function resolveDecimalPlaces(value?: number): number {
...
export function parseExactDecimal(value: any): ExactDecimalParts|undefined {
...
export function normalizeExactDecimal(value: any, decimalPlaces?: number): ExactDecimalNormalization {
  const source = decimalSource(value);
...
export function roundExactDecimal(value: any, decimalPlaces?: number): ExactDecimalNormalization {
  const places = resolveDecimalPlaces(decimalPlaces);
...
export function compareExactDecimals(left: any, right: any): number|undefined {
