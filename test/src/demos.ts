        ...
        new Part(
          { cols: 12, dense: true },
          {
            children: () => [
              ...
              new Field({
                label: 'Joined Date (ISO)',
                storage: 'joinedDateIso',
                type: 'date',
                dateFormat: 'YYYY-MM-DD',
                cols: 4,
                hint: 'Stored as a YYYY-MM-DD string.',
              }),
              new Field({
                label: 'Joined Date (Compact)',
                storage: 'joinedDateCompact',
                type: 'date',
                dateFormat: 'YYYYMMDD',
                cols: 4,
                hint: 'Stored as a YYYYMMDD number, for example 20260805.',
              }),
              new Field({
                label: 'Joined Date (Timestamp)',
                storage: 'joinedDateTimestamp',
                type: 'date',
                dateFormat: 'timestamp',
                cols: 4,
                hint: 'Stored as SimpleDate.toNumber(), the internal day-count integer.',
              }),
              new Field({
                label: 'Meeting Time (Minutes)',
                storage: 'meetingTimeMinutes',
                type: 'time',
                timeFormat: 'timestamp',
                cols: 4,
                hint: 'Stored as minutes since midnight.',
              }),
              new Field({
                label: 'Meeting Time (Compact)',
                storage: 'meetingTimeCompact',
                type: 'time',
                timeFormat: 'HHMM',
                cols: 4,
                hint: 'Stored as a compact HHMM number, for example 1430.',
              }),
              new Field({
                label: 'Meeting Time (String)',
                storage: 'meetingTimeString',
                type: 'time',
                timeFormat: 'HH:mm',
                cols: 4,
                hint: 'Stored as an HH:mm string.',
              }),
                ...
                { cols: 12, dense: true },
                {
                  children: () => [
                    ...
                    new Field({
                      ...
                      dateFormat: 'YYYYMMDD',
                      cols: 4,
                      hint: 'Dialog demo stores this date as a compact YYYYMMDD number.',
                    }),
                    new Field({
                      label: 'Reminder',
                      ...
                      timeFormat: 'HHMM',
                      cols: 4,
                      hint: 'Dialog demo stores this time as a compact HHMM number.',
                    }),
                  ],
                },
              ),
