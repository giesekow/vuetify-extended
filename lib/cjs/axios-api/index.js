...
class AxiosKeycloakClient {
    constructor(app, config) {
        ...
        this.userRef = (0, vue_1.shallowRef)(null);
        this.authenticatedRef = (0, vue_1.shallowRef)(undefined);
        this.permissionsRef = (0, vue_1.shallowRef)([]);
        this.tokenRef = (0, vue_1.shallowRef)(undefined);
...
class AxiosApplication extends SimpleEventEmitter {
    ...
    constructor(apiURL, keycloakConfig, options) {
        ...
        this.socketConnectedRef = (0, vue_1.shallowRef)(false);
        this.apiURLRef = (0, vue_1.shallowRef)(undefined);
    ...
    configureInterceptors() {
        ...
        this.client.interceptors.response.use((response) => response, (error) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axios_1.default.isAxiosError(refreshError)) {
    ...
    replaceSocket(target) {
        ...
        const socket = (0, socket_io_client_1.io)(target, Object.assign({ autoConnect: false }, (this.socketOptions || {})));
        this.socket = socket;
