    ...
    onClicked() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.options.onClicked) {
                yield this.options.onClicked(this);
            }
...
class UserArea extends base_1.UIBase {
    ...
    render() {
        ...
        return h(components_1.VMenu, {
            ...
            activator: ({ props: activatorProps }) => h(components_1.VBtn, Object.assign(Object.assign({}, activatorProps), { variant: 'text', style: {
                    ...
                    alignItems: 'center',
                    justifyContent: 'center',
                }, 'aria-label': this.$text(this.$params.name, this.$uiText('ve.user.openMenu', 'Open user menu')) }), () => this.buildActivator()),
        ...
        if (this.menuLoading.value) {
            return h(components_1.VList, { density: 'comfortable', nav: true, style: { paddingTop: '4px', paddingBottom: '8px' } }, () => [
                h(components_1.VListItem, { style: { minHeight: '52px' } }, {
                    default: () => h(components_1.VListItemTitle, { style: { fontSize: '0.92rem', opacity: '0.72' } }, () => this.$uiText('ve.common.loading', 'Loading...')),
                }),
            ]);
        }
    ...
    buildButtonEntry(entry) {
        ...
        const contentColor = 'rgb(var(--v-theme-on-surface))';
        return h(components_1.VListItem, {
            ...
            prepend: () => params.icon ? h(components_1.VIcon, {
                size: 22,
                color: params.color,
                style: {
                    opacity: '0.82',
                    color: params.color ? undefined : 'inherit',
                },
            }, () => params.icon || '') : undefined,
            default: () => h(components_1.VListItemTitle, {
                style: {
                    fontSize: '0.96rem',
                    fontWeight: '500',
                    color: 'inherit',
    ...
    initialsFromName() {
        return this.$text(this.$params.name).split(' ').filter(Boolean).slice(0, 2).map((item) => { var _a; return ((_a = item[0]) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || ''; }).join('');
    }
}
...
exports.$ATB = $ATB;
const $ENV = (params, options) => new EnvironmentTag(params || {}, options || {});
exports.$ENV = $ENV;
