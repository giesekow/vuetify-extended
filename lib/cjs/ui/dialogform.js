...
class DialogForm extends base_1.UIBase {
    constructor(params, options) {
        super();
        this.popupReady = this.$makeRef(false);
    ...
    render(props, context) {
        ...
        return h(components_1.VDialog, {
            ref: (value) => { this.overlay = value; },
            modelValue: this.dialog.value,
            persistent: this.params.value.persistent !== false,
            width: this.params.value.fullscreen ? undefined : ((_a = this.params.value.width) !== null && _a !== void 0 ? _a : "auto"),
            ...
            onAfterEnter: () => __awaiter(this, void 0, void 0, function* () {
                ...
                if ((yield (0, dialog_lifecycle_1.finishDialogEntry)((_b = this.overlay) === null || _b === void 0 ? void 0 : _b.contentEl)) &&
    ...
    hide() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mounted)
                yield this.leavePromise;
            this.leavePromise = undefined;
        });
    }
    finishLeave() {
        var _a;
        (_a = this.resolveLeave) === null || _a === void 0 ? void 0 : _a.call(this);
    ...
    focusPrimaryInput() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.dialog.value || generation !== this.popupGeneration ||
                ((_a = this.overlay) === null || _a === void 0 ? void 0 : _a.globalTop) === false ||
                ((_b = this.dialogRoot.value) === null || _b === void 0 ? void 0 : _b.contains(document.activeElement))) {
                return;
            }
