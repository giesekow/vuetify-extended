...
export type UIResolvedTableHeader<T extends UITableHeader = UITableHeader> = Omit<T, 'title' | 'children'> & {
    title?: string;
    children?: UIResolvedTableHeader[];
};
/** Resolve translatable titles without mutating application-owned header definitions. */
export declare function resolveUITableHeaders<T extends UITableHeader>(headers: readonly T[] | undefined, resolveText: UITableHeaderTextResolver): UIResolvedTableHeader<T>[];
