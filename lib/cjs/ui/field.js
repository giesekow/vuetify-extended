...
class Field extends base_1.UIBase {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item.raw instanceof File) {
                ...
                if (item.raw.type.startsWith('image/')) {
                    void dialogs_1.Dialogs.$imagePreview(objectUrl, {
                ...
                if (item.raw.type === 'application/pdf') {
                    void dialogs_1.Dialogs.$documentPreview(objectUrl, {
                        title: item.label || this.params.value.label,
                        fullscreen: this.params.value.previewFullscreen !== false,
                    });
                    return;
    ...
    buildAutocompleteTable(props, context) {
        ...
        return h('div', {
            ...
            ...(!this.$readonly ? [
                h(components_1.VAutocomplete, Object.assign(Object.assign(Object.assign(Object.assign({ modelValue: this.autocompleteTablePendingItem.value, "onUpdate:modelValue": (value) => {
    ...
    showFullscreen(data) {
        ...
        const isPdfData = typeof data === 'string' && (data.startsWith('data:application/pdf')
            || /\.pdf(\?.*)?$/i.test(data));
        if (isImageData) {
            void dialogs_1.Dialogs.$imagePreview(data, {
        ...
        if (isPdfData) {
            void dialogs_1.Dialogs.$documentPreview(data, {
                title: this.$text(this.params.value.label),
                fullscreen: this.params.value.previewFullscreen !== false,
            });
            return;
