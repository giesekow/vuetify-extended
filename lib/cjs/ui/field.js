                        ...
                        onClick: () => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                for (let i = 0; i < files.length; i++) {
                                    try {
                                        const base64 = yield (0, misc_1.fileToBase64)(files[i], this.params.value.fileMaxSize);
                                        data.push(base64);
                                    }
                                    catch (error) {
                ...
                h(components_1.VBtn, {
                    ...
                    onClick: () => __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            const base64 = yield (0, misc_1.fileToBase64)(files[0], this.params.value.fileMaxSize);
