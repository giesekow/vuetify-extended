...
class Field extends base_1.UIBase {
    ...
    buildRadioSelect(props, context) {
        ...
        return [
            ...
            h(components_1.VRadioGroup, {
                ...
                "onUpdate:focused": (ev) => this.onFocusChanged(ev)
            }, () => (this.selectItems.value || []).map((item) => h(components_1.VRadio, {
    ...
    buildCheckboxSelect(props, context) {
        ...
        return [
            ...
            ...(this.selectItems.value || []).map((item) => h(components_1.VCheckboxBtn, {
                value: item[this.params.value.itemValue || '_id'],
                modelValue: this.modelValue,
                readonly: this.$readonly,
                        ...
                        onClick: () => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                for (let i = 0; i < files.length; i++) {
                                    try {
                                        const base64 = yield (0, misc_1.fileToBase64)(files[i], this.params.value.fileMaxSize || 500);
                                        data.push(base64);
                                    }
                                    catch (error) {
                ...
                h(components_1.VBtn, {
                    ...
                    onClick: () => __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            const base64 = yield (0, misc_1.fileToBase64)(files[0], this.params.value.fileMaxSize || 500);
    ...
    buildBoolean(props, context) {
        var _a;
        const h = this.$h;
        return h(this.params.value.checkbox ? components_1.VCheckboxBtn : components_1.VSwitch, {
            modelValue: this.modelValue,
            autofocus: this.params.value.autofocus,
            label: this.params.value.label || "",
            hint: this.params.value.hint || "",
