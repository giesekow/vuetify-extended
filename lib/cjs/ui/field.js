...
class Field extends base_1.UIBase {
    ...
    buildAutocomplete(props, context) {
        ...
        return h(components_1.VAutocomplete, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, this.modelBinding()), this.inputIconProps()), (this.params.value.menuTransition !== undefined ? { transition: this.params.value.menuTransition } : {})), { autofocus: this.params.value.autofocus, label: this.resolvedLabel(), hint: this.resolvedHint(), persistentHint: !!this.params.value.hint, placeholder: this.resolvedPlaceholder(), clearable: this.params.value.clearable || false, color: this.params.value.color || "primary", variant: this.params.value.variant || ((_a = Field.defaultParams) === null || _a === void 0 ? void 0 : _a.variant), itemTitle: this.params.value.itemTitle || 'name', itemValue: master_1.Master.resolveItemValueField(this.selectItems.value, this.params.value.itemValue || this.params.value.idField), readonly: this.$readonly, items: this.selectItems.value, loading: this.autocompleteLoading.value, autoSelectFirst: true, returnObject: this.params.value.returnObject, valueComparator: (left, right) => this.autocompleteValuesEqual(left, right), multiple: this.params.value.multiple }), serverAutocompleteProps), { class: this.params.value.class || [], style: this.params.value.style || {}, rules: this.rules(), "onUpdate:focused": (ev) => this.onFocusChanged(ev) }), autocompleteSlots);
    }
