...
class Field extends base_1.UIBase {
    ...
    buildAssetRecordMetadata(record) {
        const name = nested_property_1.default.get(record, this.assetNameField()) || 'Asset';
    ...
    $uploadAssets() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                dialogs_1.Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to upload asset files.');
                throw error;
            }
            finally {
    ...
    handleSelectedFiles(files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                dialogs_1.Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to process selected files.');
            }
        });
    }
    syncResolvedAssets() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                dialogs_1.Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to resolve asset references.');
            }
        });
    }
    clearMediaValue() {
    ...
    buildCheckboxSelect(props, context) {
        ...
        return [
            ...
            ...(this.selectItems.value || []).map((item) => h(components_1.VCheckboxBtn, Object.assign(Object.assign({ value: master_1.Master.getItemId(item, this.params.value.itemValue || this.params.value.idField) }, this.modelBinding()), { readonly: this.$readonly, class: ['vef-check-select'].concat(this.params.value.class || []), style: this.params.value.style || {}, color: this.params.value.color || "primary", hint: this.params.value.hint || "", multiple: this.params.value.multiple, persistentHint: this.params.value.hint ? true : false, inline: this.params.value.inline }), {
                label: () => h('div', Object.assign(Object.assign({}, (item.props || {})), { innerHTML: item[this.params.value.itemTitle || 'name'] }))
            }))
        ];
    }
    buildAutocomplete(props, context) {
        ...
        return h(components_1.VAutocomplete, Object.assign(Object.assign(Object.assign({}, this.modelBinding()), this.inputIconProps()), { autofocus: this.params.value.autofocus, label: this.params.value.label || "", hint: this.params.value.hint || "", persistentHint: this.params.value.hint ? true : false, placeholder: this.params.value.placeholder || "", clearable: this.params.value.clearable || false, color: this.params.value.color || "primary", variant: this.params.value.variant || ((_a = Field.defaultParams) === null || _a === void 0 ? void 0 : _a.variant), itemTitle: this.params.value.itemTitle || 'name', itemValue: master_1.Master.resolveItemValueField(this.selectItems.value, this.params.value.itemValue || this.params.value.idField), readonly: this.$readonly, items: this.selectItems.value, loading: this.autocompleteLoading.value, autoSelectFirst: true, returnObject: this.params.value.returnObject, multiple: this.params.value.multiple, search: this.isServerAutocomplete() ? this.autocompleteSearchText.value : undefined, noFilter: this.isServerAutocomplete(), noDataText: this.autocompleteNoDataText(), menuProps: this.isServerAutocomplete()
                ? {
                    contentClass: this.autocompleteMenuClass,
                }
                : undefined, listProps: this.isServerAutocomplete() && loadMoreMode === 'scroll'
                ? {
                    onScrollPassive: (ev) => this.onAutocompleteListScroll(ev),
                }
                : undefined, class: this.params.value.class || [], style: this.params.value.style || {}, rules: this.rules(), "onUpdate:focused": (ev) => this.onFocusChanged(ev), "onUpdate:search": this.isServerAutocomplete()
                ? (value) => this.scheduleServerAutocompleteSearch(value || '')
                : undefined }), this.isServerAutocomplete() ? {
            ...
            selectMediaFiles: () => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if ((error === null || error === void 0 ? void 0 : error.message) !== 'No File Selected!') {
                        dialogs_1.Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to select files.');
                    }
                }
            }),
    ...
    buildFileUpload(props, context) {
        ...
        return h(components_1.VRow, {}, () => [
            h(components_1.VCol, {
                cols: 12,
            }, () => h(components_1.VFileUpload, Object.assign(Object.assign({}, this.componentOptions()), { modelValue: this.selectedFiles.value, title: this.params.value.label || '', subtitle: this.params.value.hint || this.params.value.placeholder || '', autofocus: this.params.value.autofocus, clearable: this.params.value.clearable !== false, disabled: this.$readonly, readonly: this.$readonly, multiple: this.params.value.multiple, filterByType: this.params.value.fileAccepts, color: this.params.value.color || "primary", class: this.params.value.class || [], style: this.params.value.style || {}, loading: this.assetUploading.value || this.fileUploadLoading.value, showSize: true, "onUpdate:modelValue": (value) => {
                    void this.onFileUploadChanged(value);
                }, onRejected: (files) => {
                    if (files === null || files === void 0 ? void 0 : files.length) {
                        dialogs_1.Dialogs.$error(`Unsupported file type: ${files.map((file) => file.name).join(', ')}`);
                    }
                }, "onUpdate:focused": (ev) => this.onFocusChanged(ev) }))),
            ...(items.length > 0 ? [
                h(components_1.VCol, {
