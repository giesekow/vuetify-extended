...
class Field extends base_1.UIBase {
    ...
    normalizeFileUploadValue(value) {
        if (value === undefined || value === null) {
            return this.params.value.multiple ? [] : undefined;
        }
        return value;
    }
    filterValidSelectedFiles(files) {
    ...
    onFileUploadChanged(value) {
        return __awaiter(this, void 0, void 0, function* () {
            const files = yield this.filterValidSelectedFiles(this.normalizeFilesInput(value));
            if (files.length === 0) {
            ...
            try {
                ...
                this.modelValue.value = this.normalizeFileUploadValue(yield this.createStoredUploadValue(files));
                yield this.emitFileSelected();
            }
            finally {
    ...
    buildFileUpload(props, context) {
        const h = this.$h;
        const displayItems = this.uploadDisplayItems().filter((item) => !!item);
        return h(components_1.VRow, {
            ...
            h(components_1.VCol, {
                ...
                var _a;
                return h(components_1.VFileUpload, Object.assign(Object.assign({}, this.componentOptions()), { modelValue: this.selectedFiles.value, autofocus: this.params.value.autofocus, title: this.params.value.label || '', subtitle: this.params.value.hint || this.params.value.placeholder || '', color: this.params.value.color || "primary", variant: this.params.value.variant || ((_a = Field.defaultParams) === null || _a === void 0 ? void 0 : _a.variant), readonly: this.$readonly, disabled: this.$readonly, class: this.params.value.class || [], style: this.params.value.style || {}, clearable: this.params.value.clearable !== false, multiple: this.params.value.multiple, filterByType: this.params.value.fileAccepts, loading: this.fileUploadLoading.value, showSize: true, "onUpdate:modelValue": (value) => {
            ...
            ...(displayItems.length > 0 ? [
                ...
                }, displayItems.map((item, index) => h('div', {
                    key: `${item.name}-${index}`,
                    style: {
