...
exports.$BN = exports.Button = void 0;
const base_1 = require("./base");
const components_1 = require("vuetify/components");
const shortcut_1 = require("./shortcut");
class Button extends base_1.UIBase {
    ...
    render(props, context) {
        ...
        const displayShortcut = (0, shortcut_1.describeButtonShortcut)(this.params.value.shortcut, { cmdForCtrlOnMac: this.params.value.cmdForCtrlOnMac });
        ...
        const buttonNode = h(components_1.VBtn, buttonProps, () => this.renderButtonContent(displayShortcut));
        if (!this.params.value.tooltip) {
            return buttonNode;
        }
        return h(components_1.VTooltip, {
            location: this.params.value.tooltipLocation || 'top',
            text: this.params.value.tooltip,
        }, {
            activator: ({ props: activatorProps }) => h(components_1.VBtn, Object.assign(Object.assign({}, buttonProps), activatorProps), () => this.renderButtonContent(displayShortcut)),
    ...
    renderButtonContent(displayShortcut) {
        ...
        if (this.params.value.iconOnly) {
            return h(components_1.VIcon, this.params.value.icon);
        }
        if (!displayShortcut) {
...
const $BN = (params, options) => new Button(params || {}, options || {});
exports.$BN = $BN;
