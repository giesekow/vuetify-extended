    ...
    if (params.title || params.subtitle || params.icon) {
        headerNodes.push(h('div', {
            ...
            h('div', { style: { color: textColor, minWidth: 0, flex: '1 1 auto' } }, [
                ...(params.title ? [h(components_1.VCardTitle, { style: { padding: '0px', lineHeight: '1.2', color: textColor, whiteSpace: 'normal', wordBreak: 'break-word' } }, () => owner.$text(params.title))] : []),
                ...(params.subtitle ? [h(components_1.VCardSubtitle, { style: { padding: '6px 0 0 0', color: textColor, opacity: 0.74, whiteSpace: 'normal', wordBreak: 'break-word' } }, () => owner.$text(params.subtitle))] : []),
            ]),
            ...(params.icon ? [
    ...
    validate() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const child of this.childInstances) {
                ...
                if ((0, runtime_1.isUIValidationMessage)(value))
                    return value;
            }
        });
    }
...
class DashboardListWidget extends DashboardWidget {
    ...
    renderLeading(item) {
        ...
        return h(components_1.VAvatar, { color: item.avatarColor || 'primary', rounded: 'lg', size: 36 }, () => avatarText || title.charAt(0));
    }
    dividerColor() {
        return this.$theme === 'dark' ? 'rgba(255, 255, 255, 0.18)' : 'rgba(17, 24, 39, 0.12)';
    }
        ...
        if (this.loading.value && !this.loaded.value) {
            ...
            body.push(...this.resolvedItems.value.map((item, index) => h('div', {
                ...
                h('div', { class: ['ve-dashboard-list-meta'] }, [
                    ...(item.chipText ? [h(components_1.VChip, { size: 'small', color: item.chipColor, variant: item.chipVariant || 'outlined' }, () => this.$text(item.chipText))] : []),
...
class DashboardProgressWidget extends DashboardWidget {
    ...
    renderLeading(item) {
        ...
        return h(components_1.VAvatar, { color: item.avatarColor || 'primary', variant: 'tonal', size: 40 }, () => avatarText || label.charAt(0));
    }
    onItemClicked(item, index) {
        return __awaiter(this, void 0, void 0, function* () {
...
class DashboardTimelineWidget extends DashboardWidget {
    ...
    renderLeading(item) {
        ...
        return h(components_1.VAvatar, { color: item.avatarColor || item.color || 'primary', variant: 'tonal', size: 34 }, () => avatarText || title.charAt(0));
    }
    render() {
...
class DashboardActionListWidget extends DashboardWidget {
    ...
    renderLeading(item) {
        ...
        return h(components_1.VAvatar, { color: item.avatarColor || 'primary', variant: 'tonal', rounded: 'lg', size: 38 }, () => avatarText || title.charAt(0));
    }
    onItemClicked(item, index) {
        return __awaiter(this, void 0, void 0, function* () {
            if (item.disabled) {
            ...
            body.push(...this.resolvedItems.value.map((item, index) => h('div', {
                ...
                h('div', { style: { display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0 } }, [
                    ...
                    h('div', { style: { minWidth: 0 } }, [
                        ...
                        ...(item.chipText ? [h(components_1.VChip, { size: 'x-small', color: item.chipColor, variant: 'outlined', style: { marginTop: '8px' } }, () => this.$text(item.chipText))] : []),
                    ]),
                ]),
            ...
            body.push(...this.resolvedItems.value.map((item, index) => {
                ...
                return h('div', {
                    ...
                    h('div', { style: { flex: 1, minWidth: 0 } }, [
                        ...
                        ...(item.chipText ? [h(components_1.VChip, { size: 'x-small', color, variant: 'outlined', style: { marginTop: '8px' } }, () => this.$text(item.chipText))] : []),
                    ]),
                ]);
            }));
        }
...
class Dashboard extends base_1.UIBase {
    ...
    renderHeaderMenu() {
        ...
        return h(components_1.VMenu, {
            ...
            activator: ({ props: activatorProps }) => h(components_1.VBtn, Object.assign(Object.assign({}, activatorProps), { icon: 'mdi-dots-vertical', variant: 'text', size: 'small', color: this.$textColor, 'aria-label': this.$uiText('ve.dashboard.menu.label', 'Dashboard menu'), onClick: (ev) => {
                    var _a;
    ...
    executeDashboardMenuItem(item) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, menu_1.executeMenuItemAction)(item, this);
        });
    }
    runRefreshAction() {
        return __awaiter(this, void 0, void 0, function* () {
