    ...
    if (params.title || params.subtitle || params.icon) {
        headerNodes.push(h('div', {
            ...
            h('div', { style: { color: textColor, minWidth: 0, flex: '1 1 auto' } }, [
                ...(params.title ? [h(components_1.VCardTitle, { style: { padding: '0px', lineHeight: '1.2', color: textColor, whiteSpace: 'normal', wordBreak: 'break-word' } }, () => params.title || '')] : []),
                ...(params.subtitle ? [h(components_1.VCardSubtitle, { style: { padding: '6px 0 0 0', color: textColor, opacity: 0.74, whiteSpace: 'normal', wordBreak: 'break-word' } }, () => params.subtitle || '')] : []),
            ]),
            ...(params.icon ? [
