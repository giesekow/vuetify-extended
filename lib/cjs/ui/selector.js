...
class Selector extends base_1.UIBase {
    ...
    buildTitle(props, context) {
        const h = this.$h;
        return h(components_1.VCardTitle, {}, () => h('span', {}, this.$text(this.$params.title)));
    }
    ...
    buildDefaultButtons() {
        return [
            new button_1.Button(Object.assign({ text: this.$uiText('ve.common.cancel', 'Cancel'), color: 'warning' }, (this.params.value.cancelButton || {})), {
                onClicked: () => this.onCancelClicked()
            }),
            new button_1.Button(Object.assign(Object.assign({ text: this.$uiText('ve.common.confirm', 'Confirm'), color: 'success' }, (this.params.value.saveButton || {})), { disabled: this.storage.value ? false : true }), {
