...
class AppMain extends base_1.UIBase {
    ...
    serializeSnapshotEntry(entry) {
        ...
        return JSON.stringify({
            ...
            key: entry.key,
            mode: entry.mode,
            params: (0, runtime_1.makeSerializable)(entry.params),
            state: (0, runtime_1.makeSerializable)(entry.state),
            menuRestorePath: (0, runtime_1.makeSerializable)(entry.menuRestorePath),
        });
    }
    ...
    renderCompactHeaderDrawer(showHeader) {
        ...
        sections.forEach((nodes, index) => {
            if (index > 0) {
                sectionNodes.push(h(components_1.VDivider));
            }
