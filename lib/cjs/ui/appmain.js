...
class AppMain extends base_1.UIBase {
    constructor(params, options) {
        ...
        this.boundPopStateHandler = (ev) => {
            void this.onPopState(ev);
        };
        this.boundPersistenceFlushHandler = () => {
        ...
        this.leftSideMenu = (0, vue_1.shallowRef)();
        this.rightSideMenu = (0, vue_1.shallowRef)();
        this.leftSideMenuOpen = this.$makeRef(false);
        this.rightSideMenuOpen = this.$makeRef(false);
        this.navigationOptions = Object.assign({ enabled: false, history: true, persist: true, restoreOnLoad: true, storageMode: (0, runtime_1.resolveDefaultNavigationStorageMode)(), storageKey: (0, runtime_1.navigationStorageKey)() }, ((options === null || options === void 0 ? void 0 : options.navigation) || {}));
    }
    ...
    setOptions(options) {
        ...
        this.options = Object.assign(Object.assign(Object.assign({}, this.options), rest), (navigation ? { navigation } : {}));
        if (navigation) {
            this.navigationOptions = Object.assign(Object.assign({}, this.navigationOptions), navigation);
        }
    ...
    getSideNavOptions(side) {
        const raw = side === 'left' ? this.options.leftNavOptions : this.options.rightNavOptions;
        return Object.assign({ enabled: true, side, mode: side === 'left' ? 'persistent' : 'temporary', width: side === 'left' ? 320 : 340, autoCloseOnNavigate: true, mobileMode: 'temporary' }, (raw || {}));
    }
    sideNavMenuRef(side) {
    ...
    setSideNavOpen(side, value, touched = true) {
        if (touched) {
    ...
    resolveContextualRightMenuState() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activeItem instanceof collection_1.Collection) {
                const report = activeItem.$currentReport;
                const trigger = activeItem.$currentTrigger;
                if (report === null || report === void 0 ? void 0 : report.$currentForm) {
                    const formTarget = yield report.$currentForm.getRightMenuTarget();
                    if (formTarget) {
                        return {
                            target: formTarget,
                            source: 'contextual',
                ...
                if (report) {
                    const reportTarget = yield report.getRightMenuTarget();
                    if (reportTarget) {
                        return {
                            target: reportTarget,
                            source: 'contextual',
                ...
                if (trigger) {
                    const triggerTarget = yield trigger.getRightMenuTarget();
                    if (triggerTarget) {
                        return {
            ...
            if (activeItem instanceof report_1.Report) {
                if (activeItem.$currentForm) {
                    const formTarget = yield activeItem.$currentForm.getRightMenuTarget();
                    if (formTarget) {
                        return {
                            target: formTarget,
                            source: 'contextual',
                ...
                const reportTarget = yield activeItem.getRightMenuTarget();
                if (reportTarget) {
                    return {
                        target: reportTarget,
                        source: 'contextual',
            ...
            const target = yield activeItem.getRightMenuTarget();
            if (!target) {
                return {};
            }
            return {
    ...
    resolveSideNavTarget(side) {
        return __awaiter(this, void 0, void 0, function* () {
            if (side === 'right') {
                const contextualState = yield this.resolveContextualRightMenuState();
            ...
            if (runtimeState === null || runtimeState === void 0 ? void 0 : runtimeState.target) {
                return runtimeState;
            }
            const configuredTarget = yield this.resolveConfiguredSideNavTarget(side);
            if (configuredTarget) {
                return {
    ...
    resolveSideNavMenu(side, forceReload = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resolvedState = yield this.resolveSideNavTarget(side);
            ...
            const prepared = yield appmanager_1.AppManager.prepareScreenTarget('menu', resolvedState.target, resolvedState.params);
            ...
            const allowed = typeof (menu === null || menu === void 0 ? void 0 : menu.access) === 'function' ? yield menu.access() : true;
            if (!allowed) {
                this.sideNavMenuRef(side).value = undefined;
                this.sideNavOpenRef(side).value = false;
                this.setSideNavState(side, undefined);
            ...
            const sameMenuInstance = (current === null || current === void 0 ? void 0 : current.$id) === menu.$id;
    ...
    refreshSideMenus(forceReload = false) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.resolveSideNavMenu('left', forceReload);
            yield this.resolveSideNavMenu('right', forceReload);
        });
    }
    closeTemporarySideNavsOnNavigate() {
    ...
    clearSideNav(side) {
        ...
        if ((currentState === null || currentState === void 0 ? void 0 : currentState.token) !== undefined) {
    ...
    ensureNavigationPersistence() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.navigationPersistence = yield (0, runtime_1.createNavigationPersistenceAdapter)(this.navigationOptions.storageMode || (0, runtime_1.resolveDefaultNavigationStorageMode)(), this.navigationOptions.storageKey);
            return this.navigationPersistence;
        });
    }
    shouldIncludePersistedEntry(entry, _index) {
    ...
    createSnapshot(includeExcludedFromRestore = false, includeTransientState = false) {
        return {
            version: 1,
            savedAt: Date.now(),
            stack: this.stack
                ...
                .filter((entry) => !!entry)
                .map((entry) => (Object.assign(Object.assign({}, entry), { params: (0, runtime_1.makeSerializable)(entry.params), state: includeTransientState ? (0, runtime_1.makeSerializable)(entry.state) : this.createPersistedEntryState(entry) }))),
        };
    }
    createPersistedEntryState(entry) {
        const serializedState = (0, runtime_1.makeSerializable)(entry.state);
        ...
        if (entry.type === 'collection' && serializedState && typeof serializedState === 'object') {
            return {
                restoreMode: 'shallow',
                currentObject: serializedState.currentObject,
                prevState: serializedState.prevState,
                selectedIds: (0, runtime_1.makeSerializable)(serializedState.selectedIds),
    ...
    shouldRewindBrowserHistoryAfterRestore(snapshot) {
        var _a;
        if (!this.supportsBrowserHistory() || typeof window === 'undefined') {
            return false;
        }
        const browserSnapshot = (_a = window.history.state) === null || _a === void 0 ? void 0 : _a.snapshot;
        if (!browserSnapshot || !(0, runtime_1.isValidSnapshot)(browserSnapshot)) {
            return false;
        }
        ...
        const restoredState = restoredActive.state;
        const browserState = browserActive.state;
        if ((restoredState === null || restoredState === void 0 ? void 0 : restoredState.restoreMode) !== 'shallow') {
            return false;
        }
        if ((browserState === null || browserState === void 0 ? void 0 : browserState.currentObject) !== 'report') {
            return false;
        }
        return true;
    }
    rewindBrowserHistorySilently() {
        if (!this.supportsBrowserHistory() || typeof window === 'undefined') {
            return false;
        }
    ...
    syncCurrentNavigationState(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const entry of this.stack) {
                if (entry.navigation) {
                    entry.navigation = yield this.buildNavigationEntry(entry.navigation.type, entry.item, entry.params, entry.navigation);
                }
            }
            this.syncStackRefs();
            yield this.syncNavigationPersistence();
            if (options && !options.skipHistory) {
                this.syncBrowserHistory(options === null || options === void 0 ? void 0 : options.replaceHistory);
            }
        });
    }
    ...
    afterStackChanged(options) {
        return __awaiter(this, void 0, void 0, function* () {
            this.syncStackRefs();
            if (this.navigationEnabled()) {
                yield this.syncNavigationPersistence();
            }
            if (!(options === null || options === void 0 ? void 0 : options.skipHistory)) {
                this.syncBrowserHistory(options === null || options === void 0 ? void 0 : options.replaceHistory);
            }
        });
    }
    buildNavigationTitle(item, params) {
        var _a, _b;
        return (params === null || params === void 0 ? void 0 : params.navigationTitle)
            ? this.$text(params.navigationTitle)
            : this.$text(((_a = item === null || item === void 0 ? void 0 : item.$params) === null || _a === void 0 ? void 0 : _a.title) || ((_b = item === null || item === void 0 ? void 0 : item.$params) === null || _b === void 0 ? void 0 : _b.text) || '');
    }
    buildNavigationEntry(type, item, params, existingEntry) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.navigationEnabled()) {
                return undefined;
            }
            const entry = yield appmanager_1.AppManager.buildNavigationEntry(type, item, Object.assign(Object.assign({}, (params || {})), { navigationTitle: this.buildNavigationTitle(item, params), navigationParams: params === null || params === void 0 ? void 0 : params.navigationParams, navigationState: params === null || params === void 0 ? void 0 : params.navigationState, navigationMenuRestorePath: params === null || params === void 0 ? void 0 : params.navigationMenuRestorePath, persistState: params === null || params === void 0 ? void 0 : params.persistState, excludeFromRestore: params === null || params === void 0 ? void 0 : params.excludeFromRestore, navigationKey: params === null || params === void 0 ? void 0 : params.navigationKey, mode: (_a = item === null || item === void 0 ? void 0 : item.$params) === null || _a === void 0 ? void 0 : _a.mode }), existingEntry);
            if (!entry.id) {
                entry.id = (0, runtime_1.createNavigationId)();
            }
            appmanager_1.AppManager.cacheNavigationItem(entry.id, item);
            return entry;
        });
    }
    rebuildStackFromEntries(entries) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const nextStack = [];
            for (let index = 0; index < entries.length; index += 1) {
                const entry = entries[index];
                let item = yield appmanager_1.AppManager.resolveNavigationEntry(entry);
                const previousStackItem = nextStack[nextStack.length - 1];
                if (!item && entry.type === 'menu' && (previousStackItem === null || previousStackItem === void 0 ? void 0 : previousStackItem.item) instanceof menu_1.Menu && ((_a = entry.menuRestorePath) === null || _a === void 0 ? void 0 : _a.length)) {
                    const replayStep = entry.menuRestorePath[entry.menuRestorePath.length - 1];
                    const preparedReplay = yield (0, menu_1.prepareMenuReplayTarget)(previousStackItem.item, replayStep);
                    if (preparedReplay === null || preparedReplay === void 0 ? void 0 : preparedReplay.target) {
                        const replayParams = Object.assign(Object.assign(Object.assign({}, (preparedReplay.params || {})), (entry.params || {})), { navigationKey: entry.key, navigationType: entry.type, navigationTitle: entry.title, navigationParams: entry.params, navigationState: entry.state, navigationMenuRestorePath: entry.menuRestorePath, persistState: entry.persistState, excludeFromRestore: entry.excludeFromRestore, navigation: Object.assign(Object.assign({}, ((preparedReplay.params || {}).navigation || {})), { key: entry.key, type: entry.type, title: entry.title, params: entry.params, state: entry.state, menuRestorePath: entry.menuRestorePath, persist: entry.persistState, excludeFromRestore: entry.excludeFromRestore }) });
                        const replayResolved = yield appmanager_1.AppManager.prepareScreenTarget('menu', preparedReplay.target, replayParams);
                        item = replayResolved.item;
                        if (item && typeof (item === null || item === void 0 ? void 0 : item.access) === 'function') {
                            const allowed = yield item.access();
                            if (!allowed) {
                                item = undefined;
                            }
                        }
                        if (item && preparedReplay.mode && (item === null || item === void 0 ? void 0 : item.$params)) {
                            item.$params.mode = preparedReplay.mode;
                        }
                    }
                }
                if (!item && index === 0 && entry.type === 'menu') {
                    item = yield this.menu();
                }
                if (!item) {
                    return false;
                }
                if (item instanceof menu_1.Menu && (previousStackItem === null || previousStackItem === void 0 ? void 0 : previousStackItem.item) instanceof menu_1.Menu) {
                    item.setParent(previousStackItem.item);
                }
                if (item instanceof menu_1.Menu) {
                    item.setReplayPath(entry.menuRestorePath || []);
                }
                nextStack.push({
                    type: entry.type === 'dashboard' ? 'ui' : entry.type,
                    item,
                    params: Object.assign(Object.assign({}, (entry.params || {})), { navigationKey: entry.key, navigationTitle: entry.title, navigationParams: entry.params, navigationState: entry.state, navigationMenuRestorePath: entry.menuRestorePath, persistState: entry.persistState, excludeFromRestore: entry.excludeFromRestore }),
                    navigation: entry,
                });
            }
    ...
    restoreFromSnapshot(snapshot) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!snapshot || !(0, runtime_1.isValidSnapshot)(snapshot) || snapshot.stack.length === 0) {
                return false;
            }
            this.restoringNavigation = true;
            try {
                const restored = yield this.rebuildStackFromEntries(snapshot.stack);
                return restored;
            }
            finally {
                this.restoringNavigation = false;
    ...
    restorePersistedNavigation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const adapter = yield this.ensureNavigationPersistence();
            const snapshot = yield adapter.load();
            const restored = yield this.restoreFromSnapshot(snapshot);
    ...
    onPopState(ev) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const snapshot = (_a = ev.state) === null || _a === void 0 ? void 0 : _a.snapshot;
            if (!snapshot || !(0, runtime_1.isValidSnapshot)(snapshot)) {
                if (this.pendingManagedBackToken) {
                    yield this.runPendingManagedBackFallback();
                }
                return;
            }
            this.clearPendingManagedBack();
            yield this.restoreFromSnapshot(snapshot);
        });
    }
    clearPendingManagedBack() {
    ...
    requestManagedHistoryBack(fallback) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.supportsBrowserHistory() || typeof window === 'undefined') {
                yield fallback();
                return;
    ...
    popCurrentStackItemLocally(item) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const target = item || ((_a = this.getActiveStackItem()) === null || _a === void 0 ? void 0 : _a.item);
            if (!target) {
                return;
            }
            ...
            this.index.value = this.stack.length - 1;
            yield this.activateCurrentItem();
            yield this.afterStackChanged({ replaceHistory: true, skipHistory: true });
        });
    }
    props() {
        return [];
    ...
    home() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.options.home) {
                return yield this.options.home(this);
            }
        });
    }
    emitLifecycleEvent(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.emit(name, this);
            appmanager_1.AppManager.emit(name, this);
        });
    }
    showHomeTarget(target, replaceHistory = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (target.type === 'menu') {
                yield this.$showMenu(target.target, target.params, replaceHistory);
                return;
            }
            if (target.type === 'report') {
                yield this.$showReport(target.target, target.params, false);
                if (replaceHistory) {
                    yield this.syncCurrentNavigationState({ replaceHistory: true });
                }
                return;
            }
            if (target.type === 'collection') {
                yield this.$showCollection(target.target, target.params, false);
                if (replaceHistory) {
                    yield this.syncCurrentNavigationState({ replaceHistory: true });
                }
                return;
            ...
            if (target.type === 'trigger') {
                yield this.$showTrigger(target.target, target.params, false);
                if (replaceHistory) {
                    yield this.syncCurrentNavigationState({ replaceHistory: true });
                }
                return;
            }
            yield this.$showUI(target.target, target.params, false);
            if (replaceHistory) {
                yield this.syncCurrentNavigationState({ replaceHistory: true });
            }
        });
    ...
    render(props, context) {
        ...
        return h(components_1.VApp, {
            ...
            ...(showHeader ? [
                ...
                }, [headerBar || header || h(components_1.VAppBarTitle, {}, () => this.$text(this.params.value.title, this.$uiText('ve.app.title', 'Application')))])),
            ] : []),
    ...
    resolveActiveScreenConfig(active = this.getActiveStackItem()) {
        var _a, _b, _c;
        const itemParams = (((_a = active === null || active === void 0 ? void 0 : active.item) === null || _a === void 0 ? void 0 : _a.$params) || {});
        const itemScreen = (((_b = active === null || active === void 0 ? void 0 : active.item) === null || _b === void 0 ? void 0 : _b.$screenParams) || ((_c = active === null || active === void 0 ? void 0 : active.item) === null || _c === void 0 ? void 0 : _c.$appScreenParams) || {});
        const baseScreen = {};
        if (typeof itemParams.hideSideNavs === 'boolean') {
            baseScreen.hideSideNavs = itemParams.hideSideNavs;
        }
        return Object.assign(Object.assign(Object.assign({}, itemScreen), baseScreen), ((active === null || active === void 0 ? void 0 : active.params) || {}));
    }
    shouldHideSideNavsForActiveItem() {
    ...
    resolveFabConfig() {
        ...
        return {
            showFab: (_a = screen.showFab) !== null && _a !== void 0 ? _a : this.params.value.showFab,
            fabIcon: (_b = screen.fabIcon) !== null && _b !== void 0 ? _b : this.params.value.fabIcon,
            fabColor: (_c = screen.fabColor) !== null && _c !== void 0 ? _c : this.params.value.fabColor,
            fabPosition: (_d = screen.fabPosition) !== null && _d !== void 0 ? _d : this.params.value.fabPosition,
            fabDirection: (_e = screen.fabDirection) !== null && _e !== void 0 ? _e : this.params.value.fabDirection,
            fabLabel: (_f = screen.fabLabel) !== null && _f !== void 0 ? _f : this.params.value.fabLabel,
            fabShortcut: (_g = screen.fabShortcut) !== null && _g !== void 0 ? _g : this.params.value.fabShortcut,
            fabButtons: (_h = screen.fabButtons) !== null && _h !== void 0 ? _h : this.options.fabButtons,
            active,
        };
    }
    ...
    renderFabActions(showFooter = false) {
        ...
        return h('div', {
            ...
            h(components_1.VMenu, {
                ...
                activator: ({ props: activatorProps }) => h(components_1.VBtn, Object.assign(Object.assign({}, activatorProps), { color: config.fabColor, icon: config.fabIcon, size: 'large', elevation: 8, title: this.$text(config.fabLabel), 'aria-label': this.$text(config.fabLabel), style: {
                        borderRadius: '999px',
                    } })),
    ...
    shouldShowTemporarySideNavToggle(side) {
        const options = this.getSideNavOptions(side);
    ...
    renderTemporarySideNavToggle(side) {
        if (!this.shouldShowTemporarySideNavToggle(side)) {
            return undefined;
        }
        const options = this.getSideNavOptions(side);
        const h = this.$h;
        const tooltip = this.$text(options.toggleTooltip, this.$uiText(side === 'left' ? 've.app.openLeftNav' : 've.app.openRightNav', side === 'left' ? 'Open navigation panel' : 'Open tools panel'));
    ...
    mainShellContentStyle(showFooter) {
        var _a;
        const activeItem = (_a = this.getActiveStackItem()) === null || _a === void 0 ? void 0 : _a.item;
        const reserveFooterSpace = showFooter && !(activeItem instanceof menu_1.Menu);
        return {
            position: 'relative',
            minHeight: '100%',
    ...
    renderMobileHeaderDrawer() {
        ...
        sections.forEach((section, index) => {
            if (index > 0) {
                content.push(h(components_1.VDivider, { class: ['my-2'] }));
            }
            content.push(h('div', {
                class: ['px-4', 'py-2'],
        ...
        return h(components_1.VNavigationDrawer, {
    ...
    renderSideNavDrawer(side) {
        ...
        return h(components_1.VNavigationDrawer, {
            ...
            style: {
                ...
                sideNavCloseTooltip: this.$uiText(side === 'left' ? 've.app.closeLeftNav' : 've.app.closeRightNav', side === 'left' ? 'Close navigation panel' : 'Close tools panel'),
                sideNavOnClose: () => {
    ...
    $reload() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.loadApp(false);
        });
    }
    $goBackWithFallback(fallback) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.requestManagedHistoryBack(fallback);
        });
    }
    ...
    loadApp(preferRestore = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.loadPromise = (() => __awaiter(this, void 0, void 0, function* () {
                yield this.emitLifecycleEvent('beforeLoad');
                this.fabOpen.value = false;
                this.mobileHeaderDrawerOpen.value = false;
                ...
                try {
                    ...
                    let restored = false;
                    if (preferRestore) {
                        restored = yield this.restorePersistedNavigation();
                    }
                    if (!restored && home) {
                        yield this.showHomeTarget(home, true);
                    }
                    else if (!restored && menu) {
                        yield this.$showMenu(menu, undefined, true);
                    }
                    else if (restored) {
                    ...
                    yield this.emitLifecycleEvent('loaded');
                    yield (0, vue_1.nextTick)();
                    yield this.emitLifecycleEvent('ready');
                }
                catch (error) {
                    dialogs_1.Dialogs.$hideProgress();
                    throw error;
            ...
            try {
                ...
                if (queuedLoad !== undefined) {
                    yield this.loadApp(queuedLoad);
                }
            }
        });
    }
    queueLoad(preferRestore) {
    ...
    $makeUDF(options, mode) {
        ...
        if (!ftype)
            return;
        const fieldMaps = {};
        const itemId = master_1.Master.getItemId(options, master_1.Master.getDefaultIdField());
        return new field_1.Field(Object.assign(Object.assign({ type: fieldMaps[ftype] || ftype, label: options.fieldLabel, hint: options.hint, placeholder: options.placeholder, icon: options.icon, required: options.isRequired, multiple: options.multiple || false, storage: `udfs.${itemId}`, cols: (_a = options.gridSize) === null || _a === void 0 ? void 0 : _a.cols, xs: (_b = options.gridSize) === null || _b === void 0 ? void 0 : _b.xs, sm: (_c = options.gridSize) === null || _c === void 0 ? void 0 : _c.sm, md: (_d = options.gridSize) === null || _d === void 0 ? void 0 : _d.md, lg: (_e = options.gridSize) === null || _e === void 0 ? void 0 : _e.lg, xl: (_f = options.gridSize) === null || _f === void 0 ? void 0 : _f.xl, xxl: (_g = options.gridSize) === null || _g === void 0 ? void 0 : _g.xxl }, (options.defaultValue || options.defaultValue === 0 ? { default: options.defaultValue } : {})), (options.fieldType === 'text' && options.isAutoGen && mode && ['create', 'edit'].includes(mode) ? {
            readonly: !((_h = options.autoGenInfo) === null || _h === void 0 ? void 0 : _h.enableEdit),
    ...
    $showMenu(menu, params, replaceHistory) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield appmanager_1.AppManager.prepareScreenTarget('menu', menu, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
            ...
            const navigation = yield this.buildNavigationEntry('menu', resolved.item, resolved.params || {});
            resolved.item.setReplayPath((navigation === null || navigation === void 0 ? void 0 : navigation.menuRestorePath) || []);
            this.stack.push({
                type: "menu",
                item: resolved.item,
            ...
            this.index.value = this.stack.length - 1;
            yield this.activateCurrentItem();
            yield this.afterStackChanged({ replaceHistory });
        });
    }
    $showLeftMenu(menu, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.resolveSideNavMenu('left', true);
            if (this.leftSideMenu.value) {
                this.setSideNavOpen('left', true);
            }
        });
    }
    $showRightMenu(menu, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.resolveSideNavMenu('right', true);
    ...
    $showReport(report, params, replace) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield appmanager_1.AppManager.prepareScreenTarget('report', report, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
            ...
            if (replace)
                yield this.$pop(undefined, true);
            const navigation = yield this.buildNavigationEntry('report', resolved.item, resolved.params || {});
            this.stack.push({
                type: "report",
                item: resolved.item,
                params: resolved.params || {},
            ...
            this.index.value = this.stack.length - 1;
            yield this.activateCurrentItem();
            yield this.afterStackChanged({ replaceHistory: !!replace });
        });
    }
    $showCollection(collection, params, replace) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield appmanager_1.AppManager.prepareScreenTarget('collection', collection, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
            ...
            if (replace)
                yield this.$pop(undefined, true);
            const navigation = yield this.buildNavigationEntry('collection', resolved.item, resolved.params || {});
            this.stack.push({
                type: "collection",
                item: resolved.item,
                params: resolved.params || {},
            ...
            this.index.value = this.stack.length - 1;
            yield this.activateCurrentItem();
            this.stack[this.index.value].navigation = yield this.buildNavigationEntry('collection', resolved.item, resolved.params || {}, this.stack[this.index.value].navigation);
            yield this.afterStackChanged({ replaceHistory: !!replace });
        });
    }
    $showTrigger(trigger, params, replace) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield appmanager_1.AppManager.prepareScreenTarget('trigger', trigger, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
            ...
            if (replace)
                yield this.$pop(undefined, true);
            const navigation = yield this.buildNavigationEntry('trigger', resolved.item, resolved.params || {});
            this.stack.push({
                type: "trigger",
                item: resolved.item,
                params: resolved.params || {},
    ...
    $showUI(ui, params, replace) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield appmanager_1.AppManager.prepareScreenTarget('ui', ui, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
            ...
            if (replace)
                yield this.$pop(undefined, true);
            const navType = ((_a = resolved.params) === null || _a === void 0 ? void 0 : _a.navigationType) || ((_c = (_b = resolved.params) === null || _b === void 0 ? void 0 : _b.navigationEntry) === null || _c === void 0 ? void 0 : _c.type) || 'ui';
            const navigation = yield this.buildNavigationEntry(navType, resolved.item, resolved.params || {});
            this.stack.push({
                type: "ui",
                item: resolved.item,
                params: resolved.params || {},
    ...
    $back() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.stack.length > 0) {
                const active = (_a = this.getActiveStackItem()) === null || _a === void 0 ? void 0 : _a.item;
                if (active && typeof active.canHandleBack === 'function' && (yield active.canHandleBack())) {
                    const handled = typeof active.handleBack === 'function' ? yield active.handleBack() : false;
                    if (handled) {
                        return;
                    }
                }
            ...
            if (this.stack.length > 1 && this.supportsBrowserHistory()) {
                yield this.requestManagedHistoryBack(() => __awaiter(this, void 0, void 0, function* () {
                    yield this.popCurrentStackItemLocally();
                }));
            }
    ...
    $pop(count, skipHistory = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rem < this.stack.length) {
                ...
                yield this.activateCurrentItem();
                yield this.afterStackChanged({ replaceHistory: true, skipHistory });
            }
    ...
    onCancel(item) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.supportsBrowserHistory() && this.stack.length > 1) {
                yield this.requestManagedHistoryBack(() => __awaiter(this, void 0, void 0, function* () {
                    yield this.popCurrentStackItemLocally(item);
                }));
                return;
            }
            yield this.popCurrentStackItemLocally(item);
    ...
    attachEventListeners() {
        ...
        if (typeof window !== 'undefined' && !this.browserNavigationAttached && this.supportsBrowserHistory()) {
            ...
            if (!((_a = window.history.state) === null || _a === void 0 ? void 0 : _a.__veNavigation)) {
                this.syncBrowserHistory(true);
            }
        }
        ...
        if ((0, runtime_1.detectCapacitorEnvironment)() && !this.detachCapacitorBackHandler) {
            void (0, runtime_1.attachCapacitorBackButton)(() => __awaiter(this, void 0, void 0, function* () {
                yield this.$back();
            })).then((detach) => {
    ...
    scheduleFooterHeight() {
        if (!this.footerElement || this.footerResizeFrame !== undefined)
            return;
