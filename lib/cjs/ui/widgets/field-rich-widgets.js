...
const tiptap_editor_1 = require("../tiptap-editor");
const html_editor_options_1 = require("../html-editor-options");
const VAceEditor = (0, vue_1.defineAsyncComponent)(() => __awaiter(void 0, void 0, void 0, function* () {
    yield Promise.all([
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-text'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-json'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-javascript'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-html'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-python'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-ejs'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/mode-latex'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/theme-chrome'))),
        Promise.resolve().then(() => __importStar(require('ace-builds/src-noconflict/theme-xcode'))),
    ]);
    const module = yield Promise.resolve().then(() => __importStar(require('vue3-ace-editor')));
...
function buildHTMLWidget(field) {
    ...
    const toolbar = (0, html_editor_options_1.resolveHtmlEditorToolbar)(field.params.value.htmlProfile, field.params.value.htmlToolbar, allowFullscreen);
    const showFullscreen = toolbar.includes('fullscreen');
    const editor = h(tiptap_editor_1.TiptapHtmlEditor, {
        ...
        errorMessage: ((_a = field.htmlValidationMessage) === null || _a === void 0 ? void 0 : _a.call(field)) || '',
    ...
    const fullscreenBtn = h(components_1.VBtn, {
        ...
        onClick: () => {
            var _a;
            const previewTitle = field.$text(field.params.value.label, field.$text({ key: 've.field.preview', fallback: 'Preview' }));
        ...
        <body>${field.renderMathInHtml((_a = field.modelValue.value) !== null && _a !== void 0 ? _a : "", 'mathml')}</body>
        </html>
        `;
...
function buildCodeWidget(field) {
    ...
    return [
        h('div', {
            class: ['ml-4', 'mb-4']
        }, h('label', {}, field.$text(field.params.value.label))),
        ...(field.params.value.lang === 'latex' ? [editor, fullscreenBtn] : [editor]),
        ...(field.params.value.hint ?
            [h('div', {
                    class: ['ml-4', 'mb-4']
                }, h('label', {}, field.$text(field.params.value.hint)))] : [])
    ];
}
...
function hasSeedableMapValue(field) {
    if (isCircleMap(field)) {
...
function seedMapFromCurrentLocation(field, state) {
...
function buildImageWidget(field) {
    ...
    return h(components_1.VRow, {}, () => [
        h(components_1.VCol, {
            cols: 12
        }, () => h('div', {}, field.$text(field.params.value.label))),
        ...items.map((item, index) => h(components_1.VCol, {
            key: item.key,
            cols: 12,
            md: multiple ? 6 : 12,
            lg: multiple ? 4 : 12,
            ...
            var _a;
            return [
                item.previewUrl && ((_a = item.mimeType) === null || _a === void 0 ? void 0 : _a.includes('image')) ? h(components_1.VImg, {
                    src: item.previewUrl,
            ...
            ...(items.length > 0 ? [
                ...
                ...((field.isAssetMode() && field.hasPendingUpload()) ? [
                    ...
                    h(components_1.VBtn, {
                        ...
                        class: ['ml-4'],
                        onClick: () => __awaiter(this, void 0, void 0, function* () {
                            yield field.clearSelectedFiles();
                        })
                    }, () => 'Clear Selected'),
                ] : []),
                ...(items.length === 1 && (items[0].previewUrl || items[0].downloadUrl || typeof items[0].raw === 'string') ? [h(components_1.VBtn, {
                        color: 'success',
                        class: ['ml-4'],
                        onClick: () => {
