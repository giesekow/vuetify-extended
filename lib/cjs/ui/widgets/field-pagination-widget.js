...
exports.buildPaginationWidget = void 0;
...
function buildPaginationWidget(field) {
    const h = field.$h;
    ...
    const pageSizeControls = params.showItemsPerPage === false
        ...
        : [
            h('div', { class: ['vef-pagination__page-sizes'] }, [
                ...
                ...field.$paginationItemsPerPageOptions.map((limit) => h(components_1.VBtn, {
                    key: limit,
                    size: 'small',
                    rounded: 'pill',
                    color,
...
exports.buildPaginationWidget = buildPaginationWidget;
