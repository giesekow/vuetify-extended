...
class Report extends base_1.UIBase {
    constructor(params, options) {
        super();
        this.loaded = false;
        this.initializing = this.$makeRef(true);
    ...
    validate(form, index = this.currentIndex.value) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.options.validate ? yield this.options.validate(this, form, index) : undefined;
        });
    }
    getRightMenuTarget() {
        return __awaiter(this, void 0, void 0, function* () {
            const formMenu = this.currentForm ? yield this.currentForm.getRightMenuTarget() : undefined;
            if (formMenu) {
                return formMenu;
            }
            return this.options.rightMenu ? yield this.options.rightMenu(this) : undefined;
        });
    }
            ...
            if (hasForm) {
                ...
                if (newForm) {
                    ...
                    if (this.params.value.setActionButtons || this.params.value.setActionButtons === undefined) {
                        newForm.$params.cancelButton = Object.assign(Object.assign({ text: this.$uiText('ve.common.cancel', 'Cancel'), color: 'warning', variant: this.params.value.cancelButtonStyle || 'text' }, (this.params.value.cancelButton || {})), (newForm.$params.cancelButton || {}));
                        if (this.hasNext) {
                            newForm.$params.saveButton = Object.assign(Object.assign({ text: this.$uiText('ve.common.next', 'Next'), color: 'primary', variant: this.params.value.nextButtonStyle || 'elevated' }, (this.params.value.nextButton || {})), (newForm.$params.saveButton || {}));
                        }
                        else {
                        ...
                        if (this.hasPrev) {
                            newForm.$params.prevButton = Object.assign(Object.assign({ text: this.$uiText('ve.common.prev', 'Prev'), color: 'secondary', variant: this.params.value.prevButtonStyle || 'outlined' }, (this.params.value.prevButton || {})), (newForm.$params.prevButton || {}));
                        }
                        else {
    ...
    buildTitle(props, context) {
        ...
        return h(components_1.VCardTitle, {}, () => h('span', {}, this.$params.mode
    ...
    buildMobileSideActions(buttons) {
        ...
        return h('div', {
            style: {
                ...
                activator: ({ props: activatorProps }) => h(components_1.VBtn, Object.assign(Object.assign({}, activatorProps), { variant: 'outlined', color: 'secondary', prependIcon: 'mdi-dots-vertical', size: 'small' }), () => this.$uiText('ve.common.actions', 'Actions')),
    ...
    buildDefaultButtons() {
        return [
            new button_1.Button(Object.assign({ text: this.$uiText('ve.common.cancel', 'Cancel'), color: 'warning', variant: this.params.value.cancelButtonStyle || 'text' }, (this.params.value.cancelButton || {})), {
    ...
    getAdditionalButtons() {
        ...
        if (this.params.value.canPrint && this.hasPrintAccess.value) {
            btns.push(new button_1.Button({ text: this.$uiText('ve.common.print', 'Print'), color: 'primary' }, {
                onClicked: () => {
                    this.printAction();
                }
            }));
        ...
        if (this.params.value.canExport && this.hasExportAccess.value) {
            btns.push(new button_1.Button({ text: this.$uiText('ve.common.export', 'Export'), color: 'primary' }, {
                onClicked: () => {
                    this.exportAction();
                }
            }));
    ...
    oncancel() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.params.value.confirmOnCancel) {
                const accepted = yield dialogs_1.Dialogs.$confirm(this.hasUnsavedChanges()
    ...
    applyStepSubtitle(form, index) {
        ...
        const baseSubtitle = (_a = form.__veBaseSubtitle) !== null && _a !== void 0 ? _a : this.$text(form.$params.subtitle);
        form.__veBaseSubtitle = baseSubtitle;
    ...
    forceSave() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            yield ((_a = this.currentForm) === null || _a === void 0 ? void 0 : _a.$save());
        });
    }
