...
class Dialogs {
            ...
            setup: () => {
                ...
                return () => {
                    ...
                    return (0, vue_1.h)(components_1.VDialog, {
                        ...
                        width: Dialogs.imagePreviewFullscreen.value ? undefined : ((_a = Dialogs.imagePreviewParams.value.width) !== null && _a !== void 0 ? _a : 1100),
                        maxWidth: Dialogs.imagePreviewFullscreen.value ? undefined : ((_b = Dialogs.imagePreviewParams.value.maxWidth) !== null && _b !== void 0 ? _b : '92vw'),
                        minWidth: Dialogs.imagePreviewFullscreen.value ? undefined : Dialogs.imagePreviewParams.value.minWidth,
                        height: Dialogs.imagePreviewFullscreen.value ? undefined : ((_c = Dialogs.imagePreviewParams.value.height) !== null && _c !== void 0 ? _c : '88vh'),
                        ...
                        (0, vue_1.h)('div', {
                            ...
                            }, (0, runtime_1.resolveUIText)(Dialogs.imagePreviewTitle.value, 'Image Preview')),
                            (0, vue_1.h)(components_1.VBtn, {
                                icon: true,
                                variant: 'text',
                                color: 'white',
                                title: (0, runtime_1.resolveUIText)({ key: 've.dialog.preview.zoomOut', fallback: 'Zoom out' }),
                                onClick: () => zoomBy(-0.2),
                            ...
                            (0, vue_1.h)(components_1.VBtn, {
                                ...
                                variant: 'text',
                                color: 'white',
                                title: (0, runtime_1.resolveUIText)({ key: 've.dialog.preview.resetZoom', fallback: 'Reset zoom' }),
                                onClick: () => resetView(),
                            ...
                            (0, vue_1.h)(components_1.VBtn, {
                                ...
                                variant: 'text',
                                color: 'white',
                                title: (0, runtime_1.resolveUIText)({ key: 've.dialog.preview.zoomIn', fallback: 'Zoom in' }),
                                onClick: () => zoomBy(0.2),
                            ...
                            (0, vue_1.h)(components_1.VBtn, {
                                ...
                                variant: 'text',
                                color: 'white',
                                title: (0, runtime_1.resolveUIText)({ key: 've.dialog.preview.closePreview', fallback: 'Close preview' }),
                                onClick: () => close(),
                        ...
                        (0, vue_1.h)('div', {
                            ...
                            (0, vue_1.h)('img', {
                                ...
                                alt: (0, runtime_1.resolveUIText)(Dialogs.imagePreviewTitle.value, 'Image preview'),
                                draggable: false,
                                style: {
                                    maxWidth: '100%',
                                    maxHeight: '100%',
        ...
        return (0, vue_1.defineComponent)({
            ...
            setup: () => {
                ...
                const downloadDocument = () => {
                    ...
                    link.download = (0, runtime_1.resolveUIText)(Dialogs.documentPreviewTitle.value, (0, runtime_1.resolveUIText)({ key: 've.dialog.preview.documentFallback', fallback: 'document' }));
                    link.target = '_blank';
                    link.rel = 'noopener';
                ...
                return () => {
                    ...
                    return (0, vue_1.h)(components_1.VDialog, Object.assign(Object.assign({ modelValue: Dialogs.documentPreviewDialog.value, fullscreen: Dialogs.documentPreviewFullscreen.value, width: Dialogs.documentPreviewFullscreen.value ? undefined : ((_a = Dialogs.documentPreviewWidth.value) !== null && _a !== void 0 ? _a : 1100), maxWidth: Dialogs.documentPreviewFullscreen.value ? undefined : ((_b = Dialogs.documentPreviewMaxWidth.value) !== null && _b !== void 0 ? _b : '92vw'), minWidth: Dialogs.documentPreviewFullscreen.value ? undefined : Dialogs.documentPreviewMinWidth.value, height: Dialogs.documentPreviewFullscreen.value ? undefined : ((_c = Dialogs.documentPreviewHeight.value) !== null && _c !== void 0 ? _c : '88vh'), maxHeight: Dialogs.documentPreviewFullscreen.value ? undefined : Dialogs.documentPreviewMaxHeight.value, minHeight: Dialogs.documentPreviewFullscreen.value ? undefined : Dialogs.documentPreviewMinHeight.value, persistent: false }, (Dialogs.documentPreviewScrim.value
                        ...
                        return (0, vue_1.h)(components_1.VCard, {
                            style: Object.assign(Object.assign(Object.assign({ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }, (cardBackground ? { background: cardBackground } : {})), (textColor ? { color: textColor } : {})), (Dialogs.documentPreviewCardStyle.value || {})),
                        }, () => [
                            (0, vue_1.h)('div', {
                                ...
                                (0, vue_1.h)(components_1.VBtn, Object.assign(Object.assign({ icon: true, variant: 'text' }, (textColor ? { color: textColor } : {})), { title: (0, runtime_1.resolveUIText)({ key: 've.dialog.preview.closePreview', fallback: 'Close preview' }), onClick: close }), () => (0, vue_1.h)(components_1.VIcon, {}, () => 'mdi-close')),
                            ]),
                            (0, vue_1.h)('div', {
                                ...
                                (0, vue_1.h)('iframe', {
                                    ...
                                    title: (0, runtime_1.resolveUIText)(Dialogs.documentPreviewTitle.value, 'Preview'),
    ...
    static closePrompt(value, dialog = Dialogs.promptForm.value) {
        return __awaiter(this, void 0, void 0, function* () {
