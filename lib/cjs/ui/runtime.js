...
exports.resolvePersistIntent = exports.makeSerializable = exports.isNavigationEntry = exports.isValidSnapshot = exports.attachCapacitorBackButton = exports.createNavigationPersistenceAdapter = exports.resolveDefaultNavigationStorageMode = exports.detectCapacitorEnvironment = exports.navigationStorageKey = exports.createNavigationId = exports.getNavigationTemplate = exports.setNavigationTemplate = exports.isRTLLocale = exports.formatCurrencyText = exports.formatNumberText = exports.formatDateText = exports.resolveUIText = exports.$t = exports.$l = exports.interpolateUITextTemplate = exports.resolveUIValidationMessage = exports.isUIValidationMessage = exports.isUITextDescriptor = exports.getVuetifyExtendedI18n = exports.setVuetifyExtendedI18n = void 0;
let i18nAdapter;
...
function isUIValidationMessage(value) {
    return typeof value === 'string' || typeof value === 'function' || isUITextDescriptor(value);
}
exports.isUIValidationMessage = isUIValidationMessage;
function resolveUIValidationMessage(value) {
    return isUIValidationMessage(value) ? resolveUIText(value) : undefined;
}
exports.resolveUIValidationMessage = resolveUIValidationMessage;
...
function getBrowserNavigationType() {
    var _a, _b, _c;
    const performanceApi = globalThis === null || globalThis === void 0 ? void 0 : globalThis.performance;
    try {
        const entries = (_a = performanceApi === null || performanceApi === void 0 ? void 0 : performanceApi.getEntriesByType) === null || _a === void 0 ? void 0 : _a.call(performanceApi, 'navigation');
        const type = (_b = entries === null || entries === void 0 ? void 0 : entries[0]) === null || _b === void 0 ? void 0 : _b.type;
    ...
    const legacyType = (_c = performanceApi === null || performanceApi === void 0 ? void 0 : performanceApi.navigation) === null || _c === void 0 ? void 0 : _c.type;
    if (legacyType === 1) {
        return 'reload';
    }
    if (legacyType === 0) {
...
function resolveWindowScopedNavigationStorageKey(baseKey) {
    if (typeof window === 'undefined' || !window.history) {
        return baseKey;
    }
    const currentState = window.history.state;
    const existingScopeId = typeof (currentState === null || currentState === void 0 ? void 0 : currentState[NAV_WINDOW_SCOPE_ID_KEY]) === 'string'
    ...
    const scopeId = navigationType === 'reload' && existingScopeId
        ...
        : randomId();
    try {
        window.history.replaceState(Object.assign(Object.assign({}, (typeof currentState === 'object' && currentState !== null ? currentState : {})), { [NAV_WINDOW_SCOPE_ID_KEY]: scopeId }), '', window.location.href);
    }
    catch (_error) {
        //
    }
...
function createNavigationPersistenceAdapter(mode, key) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (mode === 'custom') {
            return createWebStorageAdapter(safeWindowStorage('sessionStorage'), scopedStorageKey);
        }
        return createWebStorageAdapter(safeWindowStorage('sessionStorage'), scopedStorageKey);
    });
}
