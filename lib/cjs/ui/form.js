...
class Form extends base_1.UIBase {
    ...
    validate() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.options.validate) {
                ...
                if ((0, runtime_1.isUIValidationMessage)(v))
                    return v;
            }
            ;
            for (let i = 0; i < this.childrenInstances.length; i++) {
            ...
            if (report) {
                const v = yield report.validate(this);
                if ((0, runtime_1.isUIValidationMessage)(v))
                    return v;
            }
        });
    ...
    focusPrimaryInput() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                if ((_a = this.cardRoot.value) === null || _a === void 0 ? void 0 : _a.contains(document.activeElement))
                    return;
                if (yield this.focusSpecialFieldTarget()) {
                    return;
                }
                const target = this.findFocusTarget();
                if ((_b = this.cardRoot.value) === null || _b === void 0 ? void 0 : _b.contains(document.activeElement))
                    return;
    ...
    buildDefaultButtons() {
        const prevButtons = this.params.value.prevButton ? [
            new button_1.Button(Object.assign({ text: this.$uiText('ve.common.prev', 'Prev'), color: 'secondary' }, (this.params.value.prevButton || {})), {
        ...
        return [
            ...
            ...prevButtons,
            new button_1.Button(Object.assign({ text: this.$uiText('ve.common.save', 'Save'), color: 'success' }, (this.params.value.saveButton || {})), {
    ...
    onSaveClicked() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const validationFailed = (0, runtime_1.isUIValidationMessage)(vres);
            canProceed = !validationFailed;
            this.setValidationSummary(validationFailed ? [(0, runtime_1.resolveUIValidationMessage)(vres) || ''] : []);
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.params.value.auto && !this.params.value.sub) {
                accepted = yield dialogs_1.Dialogs.$confirm({ key: 've.form.confirmSave', fallback: 'Save data ?' });
            }
            if (accepted) {
                ...
                if (!this.params.value.sub) {
                    if (this.$master) {
                        ...
                        if (saved !== true) {
                            dialogs_1.Dialogs.$error(saved || this.$uiText('ve.form.unableToSave', 'Unable to save data!'));
                            if (this.options.onError) {
                                yield this.options.onError(this, saved);
                            }
                            this.handleOn('error', saved);
                        }
                        else {
                            if (!this.params.value.auto)
                                dialogs_1.Dialogs.$success(this.$uiText('ve.form.saved', 'Data successfully saved!'));
    ...
    setValidationSummary(messages = []) {
        ...
        if (this.validationSummary.value.length === unique.length
