...
exports.formatShortcut = exports.formatButtonShortcut = exports.shouldIgnoreShortcutTarget = exports.normalizeShortcutKey = exports.describeButtonShortcut = exports.describeShortcut = exports.normalizeButtonShortcutFromEvent = exports.normalizeButtonShortcut = exports.normalizeShortcutFromEvent = exports.normalizeShortcut = void 0;
function normalizeShortcut(shortcut, options) {
...
function normalizeShortcutFromEvent(ev, options) {
...
exports.normalizeShortcutFromEvent = normalizeShortcutFromEvent;
function normalizeButtonShortcut(shortcut, options) {
...
exports.normalizeButtonShortcut = normalizeButtonShortcut;
function normalizeButtonShortcutFromEvent(ev, options) {
...
exports.normalizeButtonShortcutFromEvent = normalizeButtonShortcutFromEvent;
function describeShortcut(shortcut, options) {
    const normalized = normalizeShortcut(shortcut, options);
    if (!normalized) {
        return undefined;
    }
...
exports.describeShortcut = describeShortcut;
function describeButtonShortcut(shortcut, options) {
...
exports.describeButtonShortcut = describeButtonShortcut;
...
exports.normalizeShortcutKey = normalizeShortcutKey;
...
exports.shouldIgnoreShortcutTarget = shouldIgnoreShortcutTarget;
function formatButtonShortcut(shortcut, options) {
    var _a;
    return (_a = describeButtonShortcut(shortcut, options)) === null || _a === void 0 ? void 0 : _a.label;
}
exports.formatButtonShortcut = formatButtonShortcut;
...
function formatShortcutPart(part, mac) {
    ...
    const labels = {
        ctrl: (0, runtime_1.resolveUIText)({ key: 've.shortcut.ctrl', fallback: 'Ctrl' }),
        alt: (0, runtime_1.resolveUIText)({ key: 've.shortcut.alt', fallback: 'Alt' }),
        shift: (0, runtime_1.resolveUIText)({ key: 've.shortcut.shift', fallback: 'Shift' }),
        meta: mac
            ? (0, runtime_1.resolveUIText)({ key: 've.shortcut.cmd', fallback: 'Cmd' })
            : (0, runtime_1.resolveUIText)({ key: 've.shortcut.ctrl', fallback: 'Ctrl' }),
    };
