...
exports.compareExactDecimals = exports.roundExactDecimal = exports.normalizeExactDecimal = exports.parseExactDecimal = exports.resolveDecimalPlaces = exports.MAX_DECIMAL_PLACES = void 0;
exports.MAX_DECIMAL_PLACES = 100;
...
function resolveDecimalPlaces(value) {
    if (value === undefined || value === null) {
        return 2;
    }
    if (!Number.isFinite(value) || !Number.isInteger(value) || value < 0 || value > exports.MAX_DECIMAL_PLACES) {
        throw new RangeError(`decimalPlaces must be an integer between 0 and ${exports.MAX_DECIMAL_PLACES}.`);
    }
    return value;
}
exports.resolveDecimalPlaces = resolveDecimalPlaces;
...
function normalizeExactDecimal(value, decimalPlaces) {
    const source = decimalSource(value);
...
function roundExactDecimal(value, decimalPlaces) {
    const places = resolveDecimalPlaces(decimalPlaces);
...
exports.roundExactDecimal = roundExactDecimal;
...
exports.compareExactDecimals = compareExactDecimals;
