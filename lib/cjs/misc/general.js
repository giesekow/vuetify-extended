...
exports.computeFunctionalCode = exports.computeFunctionalCodeAsync = exports.sortArray = exports.dateRangeToPeriod = exports.arrayToObject = exports.toDecimal = exports.$famt = exports.$amt = exports.SimpleTime = exports.SimpleDate = exports.selectExcelFile = exports.fileToBase64 = exports.selectFile = exports.sleep = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const converter = (file) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                reader.onload = (e) => {
                    const b = buffer_1.Buffer.from(e.target.result, "base64").length / 1000;
...
class SimpleDate {
    ...
    constructor(params) {
        ...
        if (params && typeof params === 'number') {
            ...
            this.timestamp = Math.ceil((0, moment_1.default)(params).unix() / this.secondsInDay);
        }
        else if (params) {
            const p = params;
            if (p.year && p.month && p.day) {
                this.timestamp = Math.ceil((0, moment_1.default)({ year: p.year, month: p.month, day: p.day }).unix() / this.secondsInDay);
            }
            else {
                this.timestamp = Math.floor((0, moment_1.default)().unix() / this.secondsInDay);
            }
        }
        else {
            this.timestamp = Math.floor((0, moment_1.default)().unix() / this.secondsInDay);
    ...
    toString() {
        const day = moment_1.default.unix(this.timestamp * this.secondsInDay);
    ...
    toMoment() {
        return moment_1.default.unix(this.toSeconds());
    }
}
