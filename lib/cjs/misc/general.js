...
const $famt = (amount, options) => {
    var _a, _b;
    const places = (0, decimal_1.resolveDecimalPlaces)(options === null || options === void 0 ? void 0 : options.decimalPlaces);
    const excessDigits = (_a = options === null || options === void 0 ? void 0 : options.excessDigits) !== null && _a !== void 0 ? _a : 'round';
    const normalize = (value) => {
        var _a;
        const result = (0, decimal_1.normalizeExactDecimal)(value, places);
        ...
        if (excessDigits === 'preserve') {
            return (_a = (0, decimal_1.parseExactDecimal)(value)) === null || _a === void 0 ? void 0 : _a.normalized;
        }
        return (0, decimal_1.roundExactDecimal)(value, places).value;
    };
    const normalized = (_b = normalize(amount)) !== null && _b !== void 0 ? _b : normalize(options === null || options === void 0 ? void 0 : options.def);
    if (!normalized) {
        return '';
    }
    const parsed = (0, decimal_1.parseExactDecimal)(normalized);
    if (!(options === null || options === void 0 ? void 0 : options.showZeros) && !/[1-9]/.test(`${parsed.integer}${parsed.fraction}`)) {
        return '';
    }
    const thousandSeparator = (options === null || options === void 0 ? void 0 : options.thouSep) || ',';
    const decimalSeparator = (options === null || options === void 0 ? void 0 : options.decimalSep) || '.';
...
const toDecimal = (value, decimals) => {
    ...
    const result = (0, decimal_1.normalizeExactDecimal)(value, decimals);
    if (result.empty || !result.valid) {
        throw new TypeError('toDecimal requires a valid, non-empty decimal value.');
    }
    if (result.exceedsScale) {
        throw new RangeError(`Decimal value cannot exceed ${(0, decimal_1.resolveDecimalPlaces)(decimals)} decimal places.`);
    }
