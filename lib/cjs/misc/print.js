...
class PrinterBase {
    ...
    compileEJS(html, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { default: ejs } = yield Promise.resolve().then(() => __importStar(require("ejs/ejs.min.js")));
            ...
            const fn = yield ejs.compile(mergedHtml, { client: true, delimiter: "%", openDelimiter: "<", closeDelimiter: ">", async: true });
