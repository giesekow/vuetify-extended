...
class Master extends lib_1.EventEmitter {
    constructor(options) {
        ...
        this.data = {};
        this.validates = [];
        this.itemId = options === null || options === void 0 ? void 0 : options.id;
        this.itemType = options === null || options === void 0 ? void 0 : options.type;
        this.parent = options === null || options === void 0 ? void 0 : options.parent;
        this.idField = (options === null || options === void 0 ? void 0 : options.idField) || "_id";
    }
    get $type() {
    ...
    save(mode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.itemType && (this.itemId || mode === "create")) {
                const data = mode === "create" ? yield this.$app.service(this.itemType).create(this.data) : yield this.$app.service(this.itemType).patch(this.itemId, this.data);
                this.data = data;
            }
