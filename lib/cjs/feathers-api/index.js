...
function extractFeathersClientErrorMessage(error) {
    var _a;
    const responseData = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data;
    const data = (error === null || error === void 0 ? void 0 : error.data) || responseData;
    if (Array.isArray(error === null || error === void 0 ? void 0 : error.message)) {
        const items = error.message.filter((item) => typeof item === 'string' && item.trim().length > 0);
        if (items.length) {
            return items.join('\n');
        }
    }
    if (typeof (error === null || error === void 0 ? void 0 : error.message) === 'string' && error.message.trim().length > 0) {
...
function normalizeFeathersClientError(error) {
    var _a, _b, _c, _d, _e;
    ...
    if (error.statusCode === undefined) {
        error.statusCode = (_d = (_c = (_b = error.code) !== null && _b !== void 0 ? _b : error.status) !== null && _c !== void 0 ? _c : data === null || data === void 0 ? void 0 : data.statusCode) !== null && _d !== void 0 ? _d : (_e = error === null || error === void 0 ? void 0 : error.response) === null || _e === void 0 ? void 0 : _e.status;
    }
    if (error.errorType === undefined && typeof (data === null || data === void 0 ? void 0 : data.error) === 'string') {
...
class FeathersApi {
    static setup(apiURL, keycloakConfig, soptions) {
        ...
        const apiURLRef = (0, vue_1.shallowRef)(normalizeApiURL(apiURL));
        const userRef = (0, vue_1.shallowRef)(null);
        const tokenRef = (0, vue_1.shallowRef)(undefined);
        const authenticatedRef = (0, vue_1.shallowRef)(undefined);
        const permissionsRef = (0, vue_1.shallowRef)([]);
        const socketConnectedRef = (0, vue_1.shallowRef)(false);
        ...
        const replaceSocket = (nextApiURL) => {
            ...
            socket = (0, socket_io_client_1.default)(nextApiURL, {
        ...
        const configureTransport = (nextApiURL) => {
            ...
            if (usesSocket) {
                ...
                const restClient = (0, rest_client_1.default)(normalizedURL);
