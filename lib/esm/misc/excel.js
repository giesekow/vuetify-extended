...
export const saveWorkBook = function (filename, workbook) {
...
export const saveWorkBooks = function (filename, workbooks, names) {
    return __awaiter(this, void 0, void 0, function* () {
        const zip = new JSZip();
...
export const readSheetFromFile = function (file, sheetName, headers, hasHeaders) {
    return __awaiter(this, void 0, void 0, function* () {
...
export const readRowsFromFile = function (file, sheetName, start, length) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const workbook = new Excel.Workbook();
        yield workbook.xlsx.load(file);
...
export const writeData = function (sheetNames, data, workbook) {
    if (!workbook)
...
export const writeTables = function (sheetNames, data, workbook) {
    if (!workbook)
        workbook = new Excel.Workbook();
    for (let i = 0; i < sheetNames.length; i++) {
        const sn = sheetNames[i];
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            for (let hr = 0; hr < headers.length; hr++) {
                ...
                if (typeof headerItem === "string") {
                    ...
                    let value = headerItem.value ? getField(item, headerItem.value) : "";
