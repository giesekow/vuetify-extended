...
import { normalizeExactDecimal, parseExactDecimal, resolveDecimalPlaces, roundExactDecimal, } from './decimal';
...
export const $famt = (amount, options) => {
    var _a, _b;
    const places = resolveDecimalPlaces(options === null || options === void 0 ? void 0 : options.decimalPlaces);
    ...
    const normalize = (value) => {
        ...
        if (excessDigits === 'preserve') {
            return (_a = parseExactDecimal(value)) === null || _a === void 0 ? void 0 : _a.normalized;
        }
...
export const $zFill = (v, precision) => {
...
export const arrayToObject = (items, options) => {
    const data = {};
    const key = (options === null || options === void 0 ? void 0 : options.key) || Master.resolveItemValueField(items);
