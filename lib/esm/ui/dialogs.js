                        ...
                        h('div', {
                            ...
                            ...(menuActions.length ? [
                                h(VMenu, {
                                    ...
                                    activator: ({ props: activatorProps }) => h(VBtn, Object.assign(Object.assign(Object.assign(Object.assign({}, activatorProps), { icon: true, variant: 'text' }), (textColor ? { color: textColor } : {})), { title: 'More actions' }), () => h(VIcon, {}, () => 'mdi-dots-vertical')),
                                    default: () => h(VCard, {
                                        elevation: 8,
                                        rounded: 'lg',
                            ...
                            h(VBtn, Object.assign(Object.assign({ icon: true, variant: 'text' }, (textColor ? { color: textColor } : {})), { title: 'Close preview', onClick: close }), () => h(VIcon, {}, () => 'mdi-close')),
                        ]),
                        h('div', {
...
Dialogs.documentPreviewTitle = ref('');
