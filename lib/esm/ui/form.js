...
import { isUIValidationMessage, resolveUIValidationMessage } from "./runtime";
export class Form extends UIBase {
    ...
    buildDefaultButtons() {
        const prevButtons = this.params.value.prevButton ? [
            new Button(Object.assign({ text: this.$uiText('ve.common.prev', 'Prev'), color: 'secondary' }, (this.params.value.prevButton || {})), {
        ...
        return [
            ...
            ...prevButtons,
            new Button(Object.assign({ text: this.$uiText('ve.common.save', 'Save'), color: 'success' }, (this.params.value.saveButton || {})), {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.params.value.auto && !this.params.value.sub) {
                accepted = yield Dialogs.$confirm({ key: 've.form.confirmSave', fallback: 'Save data ?' });
            }
            if (accepted) {
                    ...
                    if (this.$master) {
                        ...
                        if (saved !== true) {
                            ...
                            if (!this.params.value.auto)
                                Dialogs.$success(this.$uiText('ve.form.saved', 'Data successfully saved!'));
