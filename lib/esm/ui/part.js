...
export class Part extends UIBase {
    constructor(params, options) {
        ...
        this.cnt = 0;
        this.params = this.$makeRef(Object.assign(Object.assign({}, Part.defaultParams), (params || {})));
    ...
    static setDefault(value, reset) {
        if (reset) {
            ...
            Part.defaultParams = Object.assign(Object.assign({}, Part.defaultParams), value);
        }
    }
    get $refs() {
        const items = {};
...
Part.defaultParams = {};
export const $PT = (params, options) => new Part(params || {}, options || {});
