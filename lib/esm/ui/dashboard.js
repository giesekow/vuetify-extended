...
export class Dashboard extends UIBase {
    ...
    renderHeaderMenu() {
        ...
        return h(VMenu, {
            ...
            activator: ({ props: activatorProps }) => h(VBtn, Object.assign(Object.assign({}, activatorProps), { icon: 'mdi-dots-vertical', variant: 'text', size: 'small', color: this.$textColor, 'aria-label': 'Dashboard menu', onClick: (ev) => {
                    var _a;
