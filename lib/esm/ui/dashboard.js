...
import { VAvatar, VBtn, VCard, VCardSubtitle, VCardText, VCardTitle, VChip, VCol, VContainer, VIcon, VList, VListItem, VMenu, VProgressLinear, VRow, VTable, VTextField, } from 'vuetify/components';
import { Dialogs } from './dialogs';
import { executeMenuItemAction } from './menu';
import { describeShortcut, normalizeShortcut, normalizeShortcutFromEvent } from './shortcut';
import { isUIValidationMessage } from './runtime';
...
function truncateButtonText(owner, text) {
    return owner.$h('span', {
        style: {
            display: 'block',
            width: '100%',
...
function truncateButtonInlineContent(owner, text, trailing = []) {
    return owner.$h('span', {
        style: {
            display: 'inline-flex',
            alignItems: 'center',
...
function readVuetifyThemeClass(element) {
    if (!element) {
        return undefined;
    }
...
function detectVuetifyThemeMode() {
...
function describeDashboardMenuShortcut(item) {
    var _a;
    return (_a = describeShortcut(item.$params.shortcut, { cmdForCtrlOnMac: item.$params.cmdForCtrlOnMac })) === null || _a === void 0 ? void 0 : _a.label;
}
        ...
        headerNodes.push(h('div', {
            ...
            ...(params.icon ? [
                h(VIcon, {
                    ...
                    style: {
                        flexShrink: 0,
                        alignSelf: params.subtitle ? 'flex-start' : 'center',
                    },
                })
            ] : []),
        ]));
...
export class DashboardWidget extends UIBase {
    ...
    attachEventListeners() {
        ...
        if (this.$parent && this.$parent.$theme !== undefined) {
            return;
        }
    ...
    removeEventListeners() {
        var _a;
        (_a = this.vuetifyThemeObserver) === null || _a === void 0 ? void 0 : _a.disconnect();
    ...
    validate() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const child of this.childInstances) {
                ...
                if (isUIValidationMessage(value))
                    return value;
            }
        });
    }
...
export class DashboardTableWidget extends DashboardWidget {
    ...
    render() {
        ...
        if (this.loading.value && !this.loaded.value) {
            ...
            body.push(h(VTable, { density: 'comfortable', class: ['bg-transparent'], style: { background: 'transparent', color: this.$textColor } }, {
                default: () => [
                    h('thead', [
    ...
    render() {
        ...
        if (this.loading.value && !this.loaded.value) {
            ...
            body.push(...this.resolvedItems.value.map((item, index) => h('div', {
                ...
                style: Object.assign({ borderBottom: showSeparator ? `1px solid ${dividerColor}` : undefined }, (this.listOptions.onItemClicked ? { cursor: 'pointer' } : {})),
                onClick: () => {
...
export class Dashboard extends UIBase {
    ...
    refresh(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const refreshPromise = this.refreshPromise || (() => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                for (const child of this.childInstances) {
                    yield ((_b = (_a = child).refresh) === null || _b === void 0 ? void 0 : _b.call(_a));
                }
                yield this.loadDashboardMenuItems(true);
            }))();
    ...
    renderHeaderMenu() {
        ...
        return h(VMenu, {
            ...
            activator: ({ props: activatorProps }) => h(VBtn, Object.assign(Object.assign({}, activatorProps), { icon: 'mdi-dots-vertical', variant: 'text', size: 'small', color: this.$textColor, 'aria-label': this.$uiText('ve.dashboard.menu.label', 'Dashboard menu'), onClick: (ev) => {
                    var _a;
    ...
    runRefreshAction() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.refresh({ progress: true });
        });
    }
...
export const $DB = (params, options) => new Dashboard(params || {}, options || {});
export const $DW = (params, options) => new DashboardWidget(params || {}, options || {});
export const $DMW = (params, options) => new DashboardMetricWidget(params || {}, options || {});
export const $DTW = (params, options) => new DashboardTableWidget(params || {}, options || {});
export const $DLW = (params, options) => new DashboardListWidget(params || {}, options || {});
export const $DPW = (params, options) => new DashboardProgressWidget(params || {}, options || {});
export const $DCHW = (params, options) => new DashboardChartWidget(params || {}, options || {});
export const $DTrW = (params, options) => new DashboardTrendWidget(params || {}, options || {});
export const $DTLW = (params, options) => new DashboardTimelineWidget(params || {}, options || {});
export const $DALW = (params, options) => new DashboardActionListWidget(params || {}, options || {});
export const $DAW = (params, options) => new DashboardAlertWidget(params || {}, options || {});
export const $DESW = (params, options) => new DashboardEmptyStateWidget(params || {}, options || {});
export const $DSGW = (params, options) => new DashboardStatGridWidget(params || {}, options || {});
export const $DMaW = (params, options) => new DashboardMapWidget(params || {}, options || {});
export const $DCaW = (params, options) => new DashboardCalendarWidget(params || {}, options || {});
export const $DTabW = (params, options) => new DashboardTabsWidget(params || {}, options || {});
