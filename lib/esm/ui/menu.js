...
export class Menu extends UIBase {
    ...
    build(props, context) {
        ...
        return this.$h(VRow, {
            ...
            return [
                ...
                ...this.childrenInstances.map((item, index) => h(VCol, {
    ...
    resolveInlineSideNavMenu(item) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resolved = yield AppManager.prepareScreenTarget('menu', target, params);
        ...
        return this.childrenInstances.map((item, index) => {
            ...
            return h('div', {
                ...
                h(VListItem, {
                    ...
                    prepend: () => item.$params.icon ? h(VAvatar, {
                        size: 34,
                        style: {
...
export function prepareMenuReplayTarget(parent, step) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
...
function showPreparedMenuItemTarget(type, target, params, replace, mode) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const resolved = yield AppManager.prepareScreenTarget(type, target, params);
        if (!resolved.item) {
            return;
        }
        ...
        if (type === 'menu') {
            AppManager.showMenu(resolved.item, resolved.params);
            return;
        }
        if (type === 'report') {
            AppManager.showReport(resolved.item, resolved.params, replace);
            return;
        }
        if (type === 'collection') {
            AppManager.showCollection(resolved.item, resolved.params, replace);
            return;
        }
        if (type === 'trigger') {
            AppManager.showTrigger(resolved.item, resolved.params, replace);
            return;
        }
        AppManager.showUI(resolved.item, resolved.params, replace);
    });
}
export function executeMenuItemAction(item, parent) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const mode = item.$params.mode;
