...
export const TiptapHtmlEditor = defineComponent({
    ...
    setup(props, { emit, attrs }) {
        ...
        watch(() => [props.label, props.placeholder, props.hint, props.errorMessage, props.required, props.readonly, props.disabled], () => { var _a; return (_a = editor.value) === null || _a === void 0 ? void 0 : _a.setOptions({ editorProps: { attributes: editorAttributes } }); });
        return () => {
            revision.value;
            const instance = editor.value;
