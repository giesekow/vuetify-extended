...
import { defineComponent, h as vueH, mergeProps, onBeforeUnmount, onMounted, ref, shallowRef, watch } from 'vue';
...
export const TiptapHtmlEditor = defineComponent({
    ...
    setup(props, { emit, attrs }) {
        ...
        return () => {
            ...
            const toolbar = !isReadOnly ? vueH('div', {
            ...
            return vueH('div', {
                ...
                props.allowFullscreen ? vueH(VDialog, {
