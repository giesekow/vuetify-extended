...
export class Report extends UIBase {
    ...
    render(props, context) {
        ...
        if (this.currentForm) {
            return h(VContainer, {
                ...
                this.wrapWithSideButtons(props, context, h(this.currentForm.component))
            ])))));
        }
        return h('div');
    }
    ...
    buildProgressHeader() {
        ...
        return h(VCard, {
            ...
            class: ['mx-auto'],
            style: {
                width: ((_a = this.currentForm) === null || _a === void 0 ? void 0 : _a.$params.width) || ((_b = this.currentForm) === null || _b === void 0 ? void 0 : _b.$params.maxWidth) || '100%',
                maxWidth: ((_c = this.currentForm) === null || _c === void 0 ? void 0 : _c.$params.maxWidth) || ((_d = this.currentForm) === null || _d === void 0 ? void 0 : _d.$params.width) || '100%',
            },
        }, () => h(VCardText, {
            style: {
                display: 'flex',
