...
export class Report extends UIBase {
    ...
    render(props, context) {
        ...
        if (this.initializing.value || this.currentIndex.value === -1 || !this.hasAccess.value) {
            ...
            }, () => this.wrapWithSideButtons(props, context, h(VCard, {
                style: {
    ...
    buildTitle(props, context) {
        ...
        return h(VCardTitle, {}, () => h('span', {}, this.$params.mode
    ...
    buildMobileSideActions(buttons) {
        ...
        return h('div', {
            style: {
                ...
                activator: ({ props: activatorProps }) => h(VBtn, Object.assign(Object.assign({}, activatorProps), { variant: 'outlined', color: 'secondary', prependIcon: 'mdi-dots-vertical', size: 'small' }), () => this.$uiText('ve.common.actions', 'Actions')),
                default: () => h(VCard, {
                    elevation: 2,
                    style: {
                        width: this.clampToViewport(this.params.value.sideButtonWidth, this.params.value.sideButtonWidth || 180),
    ...
    buildDefaultButtons() {
        return [
            new Button(Object.assign({ text: this.$uiText('ve.common.cancel', 'Cancel'), color: 'warning', variant: this.params.value.cancelButtonStyle || 'text' }, (this.params.value.cancelButton || {})), {
    ...
    getAdditionalButtons() {
        ...
        if (this.params.value.canPrint && this.hasPrintAccess.value) {
            btns.push(new Button({ text: this.$uiText('ve.common.print', 'Print'), color: 'primary' }, {
                onClicked: () => {
                    this.printAction();
                }
            }));
        ...
        if (this.params.value.canExport && this.hasExportAccess.value) {
            btns.push(new Button({ text: this.$uiText('ve.common.export', 'Export'), color: 'primary' }, {
                onClicked: () => {
                    this.exportAction();
                }
            }));
    ...
    oncancel() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.params.value.confirmOnCancel) {
                const accepted = yield Dialogs.$confirm(this.hasUnsavedChanges()
