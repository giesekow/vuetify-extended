...
import { defineComponent, h as vueH, markRaw, nextTick, onBeforeUnmount, onMounted, shallowRef } from "vue";
...
function isPdfAttachment(attachment) {
    ...
    return typeof (attachment === null || attachment === void 0 ? void 0 : attachment.url) === 'string' && (attachment.url.startsWith('data:application/pdf')
