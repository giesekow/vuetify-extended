...
import { defineAsyncComponent, defineComponent, h as vueH, markRaw, nextTick, onBeforeUnmount, onMounted, shallowRef } from "vue";
...
const VAceEditor = defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
    yield Promise.all([
    ...
    const module = yield import('vue3-ace-editor');
...
const SafeGoogleMap = defineComponent({
    ...
    setup(props, { slots }) {
        ...
        return () => renderReady.value ? vueH(GoogleMap, Object.assign(Object.assign({}, props.mapProps), { apiPromise: guardedPromise }), slots) : null;
    },
});
export function buildHTMLWidget(field) {
    ...
    const toolbar = resolveHtmlEditorToolbar(field.params.value.htmlProfile, field.params.value.htmlToolbar, allowFullscreen);
    const showFullscreen = toolbar.includes('fullscreen');
    const editor = h(TiptapHtmlEditor, {
...
export function buildMapWidget(field) {
    ...
    if (isPolygonMap(field)) {
        ...
        if (clusterValues.length) {
            mapChildren.push(h(MarkerCluster, {
...
export function buildImageWidget(field) {
    ...
    return h(VRow, {}, () => [
        ...
        ...items.map((item, index) => h(VCol, {
            ...
            var _a;
            return [
                item.previewUrl && ((_a = item.mimeType) === null || _a === void 0 ? void 0 : _a.includes('image')) ? h(VImg, {
                    src: item.previewUrl,
        ...
        h(VCol, {
            ...
            ...(items.length > 0 ? [
                ...
                ...(items.length === 1 && (items[0].previewUrl || items[0].downloadUrl || typeof items[0].raw === 'string') ? [h(VBtn, {
                        color: 'success',
                        class: ['ml-4'],
                        onClick: () => {
