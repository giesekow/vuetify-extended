...
import { createNavigationId, getNavigationTemplate, resolveUIText, setNavigationTemplate } from "./runtime";
export class AppManager {
    ...
    static buildNavigationEntry(type, item, params, existingEntry) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                id: (existingEntry === null || existingEntry === void 0 ? void 0 : existingEntry.id) || createNavigationId(),
