...
import { attachCapacitorBackButton, createNavigationPersistenceAdapter, createNavigationId, detectCapacitorEnvironment, isValidSnapshot, makeSerializable, navigationStorageKey, resolveDefaultNavigationStorageMode } from "./runtime";
export class AppMain extends UIBase {
    constructor(params, options) {
        ...
        this.navigationOptions = Object.assign({ enabled: false, history: true, persist: true, restoreOnLoad: true, storageMode: resolveDefaultNavigationStorageMode(), storageKey: navigationStorageKey() }, ((options === null || options === void 0 ? void 0 : options.navigation) || {}));
    }
    ...
    resolveSideNavMenu(side, forceReload = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prepared = yield AppManager.prepareScreenTarget('menu', resolvedState.target, resolvedState.params);
    ...
    ensureNavigationPersistence() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.navigationPersistence = yield createNavigationPersistenceAdapter(this.navigationOptions.storageMode || resolveDefaultNavigationStorageMode(), this.navigationOptions.storageKey);
            return this.navigationPersistence;
        });
    }
    ...
    createSnapshot(includeExcludedFromRestore = false, includeTransientState = false) {
        return {
            ...
            stack: this.stack
                ...
                .filter((entry) => !!entry)
                .map((entry) => (Object.assign(Object.assign({}, entry), { params: makeSerializable(entry.params), state: includeTransientState ? makeSerializable(entry.state) : this.createPersistedEntryState(entry) }))),
        };
    }
    createPersistedEntryState(entry) {
        ...
        if (entry.type === 'collection' && serializedState && typeof serializedState === 'object') {
            return {
                ...
                selectedIds: makeSerializable(serializedState.selectedIds),
    ...
    rebuildStackFromEntries(entries) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let index = 0; index < entries.length; index += 1) {
                ...
                let item = yield AppManager.resolveNavigationEntry(entry);
                const previousStackItem = nextStack[nextStack.length - 1];
                if (!item && entry.type === 'menu' && (previousStackItem === null || previousStackItem === void 0 ? void 0 : previousStackItem.item) instanceof Menu && ((_a = entry.menuRestorePath) === null || _a === void 0 ? void 0 : _a.length)) {
                    const replayStep = entry.menuRestorePath[entry.menuRestorePath.length - 1];
                    const preparedReplay = yield prepareMenuReplayTarget(previousStackItem.item, replayStep);
                    if (preparedReplay === null || preparedReplay === void 0 ? void 0 : preparedReplay.target) {
                        ...
                        const replayResolved = yield AppManager.prepareScreenTarget('menu', preparedReplay.target, replayParams);
                ...
                if (item instanceof Menu && (previousStackItem === null || previousStackItem === void 0 ? void 0 : previousStackItem.item) instanceof Menu) {
    ...
    renderFabActions(showFooter = false) {
        ...
        return h('div', {
            ...
            h(VMenu, {
                ...
                activator: ({ props: activatorProps }) => h(VBtn, Object.assign(Object.assign({}, activatorProps), { color: config.fabColor, icon: config.fabIcon, size: 'large', elevation: 8, title: this.$text(config.fabLabel), 'aria-label': this.$text(config.fabLabel), style: {
                        borderRadius: '999px',
                    } })),
                default: () => h(VCard, {
                    elevation: 8,
    ...
    $showMenu(menu, params, replaceHistory) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield AppManager.prepareScreenTarget('menu', menu, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
    ...
    $showReport(report, params, replace) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield AppManager.prepareScreenTarget('report', report, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
    ...
    $showCollection(collection, params, replace) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield AppManager.prepareScreenTarget('collection', collection, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
    ...
    $showTrigger(trigger, params, replace) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield AppManager.prepareScreenTarget('trigger', trigger, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
    ...
    $showUI(ui, params, replace) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield AppManager.prepareScreenTarget('ui', ui, params);
            if (!resolved.item) {
                return;
            }
            if (this.index.value >= 0 && this.index.value < this.stack.length) {
    ...
    attachEventListeners() {
        ...
        if (detectCapacitorEnvironment() && !this.detachCapacitorBackHandler) {
            void attachCapacitorBackButton(() => __awaiter(this, void 0, void 0, function* () {
                yield this.$back();
            })).then((detach) => {
