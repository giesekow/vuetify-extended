...
export class Selector extends UIBase {
    ...
    buildTitle(props, context) {
        const h = this.$h;
        return h(VCardTitle, {}, () => h('span', {}, this.$text(this.$params.title)));
    }
    ...
    buildDefaultButtons() {
        return [
            new Button(Object.assign({ text: this.$uiText('ve.common.cancel', 'Cancel'), color: 'warning' }, (this.params.value.cancelButton || {})), {
                onClicked: () => this.onCancelClicked()
            }),
            new Button(Object.assign(Object.assign({ text: this.$uiText('ve.common.confirm', 'Confirm'), color: 'success' }, (this.params.value.saveButton || {})), { disabled: this.storage.value ? false : true }), {
