...
export class Field extends UIBase {
            ...
            if (this.resolvedUploadType() === 'metadata') {
                const metadata = files.map((file) => {
                    ...
                    return ({
                        ...
                        extension: file.name.includes('.') ? (_a = file.name.split('.').pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase() : undefined,
                    });
                });
    ...
    buildFileUpload(props, context) {
        ...
        return h(VRow, {}, () => [
            h(VCol, {
                cols: 12,
            }, () => h(VFileUpload, Object.assign(Object.assign({}, this.componentOptions()), { modelValue: this.selectedFiles.value, title: this.params.value.label || '', subtitle: this.params.value.hint || this.params.value.placeholder || '', autofocus: this.params.value.autofocus, clearable: this.params.value.clearable !== false, disabled: this.$readonly, readonly: this.$readonly, multiple: this.params.value.multiple, filterByType: this.params.value.fileAccepts, color: this.params.value.color || "primary", class: this.params.value.class || [], style: this.params.value.style || {}, loading: this.assetUploading.value, showSize: true, "onUpdate:modelValue": (value) => {
