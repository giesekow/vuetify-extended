...
import { VAutocomplete, VBtn, VCard, VCardActions, VCardText, VCheckboxBtn, VCol, VColorPicker, VCombobox, VDialog, VIcon, VImg, VListItem, VRadio, VRadioGroup, VRow, VSelect, VSheet, VSpacer, VSwitch, VTextField, VTextarea } from 'vuetify/components';
...
export class Field extends UIBase {
    ...
    buildRadioSelect(props, context) {
        ...
        return [
            ...
            h(VRadioGroup, {
                ...
                "onUpdate:focused": (ev) => this.onFocusChanged(ev)
            }, () => (this.selectItems.value || []).map((item) => h(VRadio, {
    ...
    buildCheckboxSelect(props, context) {
        ...
        return [
            ...
            ...(this.selectItems.value || []).map((item) => h(VCheckboxBtn, {
                value: item[this.params.value.itemValue || '_id'],
                modelValue: this.modelValue,
                readonly: this.$readonly,
    ...
    buildHTML(props, context) {
        ...
        <bod>${this.renderMathInHtml((_a = this.modelValue.value) !== null && _a !== void 0 ? _a : "")}</body>
        </html>
        `;
    ...
    buildCode(props, context) {
        ...
        const editor = h(VAceEditor, {
            value: (_a = this.modelValue.value) !== null && _a !== void 0 ? _a : "",
        ...
        const fullscreenBtn = h(VBtn, {
            ...
            onClick: () => {
                var _a;
                this.renderLatex((_a = this.modelValue.value) !== null && _a !== void 0 ? _a : "");
        ...
        return [
            ...
            ...(this.params.value.hint ?
                [h('div', {
                        class: ['ml-4', 'mb-4']
                    }, h('label', {}, this.params.value.hint))] : [])
        ];
    }
                        ...
                        onClick: () => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                for (let i = 0; i < files.length; i++) {
                                    try {
                                        const base64 = yield fileToBase64(files[i], this.params.value.fileMaxSize || 500);
                                        data.push(base64);
                                    }
                                    catch (error) {
                ...
                h(VBtn, {
                    ...
                    onClick: () => __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            const base64 = yield fileToBase64(files[0], this.params.value.fileMaxSize || 500);
    ...
    buildBoolean(props, context) {
        var _a;
        const h = this.$h;
        return h(this.params.value.checkbox ? VCheckboxBtn : VSwitch, {
            modelValue: this.modelValue,
            autofocus: this.params.value.autofocus,
            label: this.params.value.label || "",
            hint: this.params.value.hint || "",
