    ...
    $uploadAssets() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to upload asset files.');
                throw error;
            }
            finally {
    ...
    handleSelectedFiles(files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to process selected files.');
            }
        });
    }
    syncResolvedAssets() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to resolve asset references.');
            }
        });
    }
    clearMediaValue() {
            ...
            selectMediaFiles: () => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if ((error === null || error === void 0 ? void 0 : error.message) !== 'No File Selected!') {
                        Dialogs.$error((error === null || error === void 0 ? void 0 : error.message) || 'Failed to select files.');
                    }
                }
            }),
