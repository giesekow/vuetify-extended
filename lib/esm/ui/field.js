...
export class Field extends UIBase {
    ...
    buildAutocompleteTable(props, context) {
        ...
        return h('div', {
            ...
            ...(!this.$readonly ? [
                h(VAutocomplete, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ modelValue: this.autocompleteTablePendingItem.value, "onUpdate:modelValue": (value) => {
