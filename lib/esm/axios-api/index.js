...
function extractAxiosErrorMessage(error) {
    ...
    if (typeof (data === null || data === void 0 ? void 0 : data.message) === 'string' && data.message.trim().length > 0) {
        return data.message;
    }
    ...
    if (typeof (data === null || data === void 0 ? void 0 : data.error) === 'string' && data.error.trim().length > 0) {
        return data.error;
    }
    return error.message;
}
function normalizeAxiosError(error) {
    ...
    const data = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data;
    const statusCode = (_b = data === null || data === void 0 ? void 0 : data.statusCode) !== null && _b !== void 0 ? _b : (_c = error.response) === null || _c === void 0 ? void 0 : _c.status;
    ...
    if (typeof (data === null || data === void 0 ? void 0 : data.error) === 'string' && !error.errorType) {
...
class AxiosKeycloakClient {
    constructor(app, config) {
        ...
        this.userRef = shallowRef(null);
        this.authenticatedRef = shallowRef(undefined);
        this.permissionsRef = shallowRef([]);
        this.tokenRef = shallowRef(undefined);
    ...
    syncDerivedRefs() {
        ...
        this.permissionsRef.value = ((_a = this.currentUser) === null || _a === void 0 ? void 0 : _a.permissions) || [];
    }
    get storage() {
    ...
    syncCurrentUser(mode, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mode === 'create') {
                ...
                if (method === 'get') {
                    this.setCurrentUser(yield service.get(null));
                }
                else if (method === 'put') {
                    this.setCurrentUser(yield service.update(null, { access_token: token }));
                }
                else {
                    this.setCurrentUser(yield service.create({ access_token: token }));
                }
                return this.currentUser;
            }
            ...
            if (refreshMethod === 'get') {
                ...
                this.setCurrentUser(yield service.patch(null, { access_token: token }));
            }
            return this.currentUser;
        });
    }
...
export class AxiosApplication extends SimpleEventEmitter {
    get user() {
    ...
    onSocket(event, listener) {
        ...
        (_a = this.socketListeners.get(event)) === null || _a === void 0 ? void 0 : _a.add(listener);
        (_b = this.socket) === null || _b === void 0 ? void 0 : _b.on(event, listener);
        return this;
    }
    ...
    constructor(apiURL, keycloakConfig, options) {
        ...
        this.socketConnectedRef = shallowRef(false);
        this.apiURLRef = shallowRef(undefined);
        ...
        this.client = axios.create(Object.assign({ baseURL: apiURL }, ((options === null || options === void 0 ? void 0 : options.axiosConfig) || {})));
    ...
    attachCustomSocketListeners(socket) {
    ...
    bindSocketEvents(socket) {
        ...
        socket.on(this.socketEvent, (payload) => {
            if (this.socket !== socket) {
                return;
            }
    ...
    replaceSocket(target) {
        ...
        const socket = io(target, Object.assign({ autoConnect: false }, (this.socketOptions || {})));
        this.socket = socket;
