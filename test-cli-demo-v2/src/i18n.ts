...
const messages: Record<LocaleCode, Record<string, string>> = {
  en: {
    ...
    'bootstrap.sideNav.tools.title': 'Workspace Tools',
    'bootstrap.sideNav.tools.theme.text': 'Toggle Theme',
    'bootstrap.sideNav.tools.language.text': 'Toggle Language',
    'bootstrap.sideNav.tools.language.subText': 'Switch the demo locale instantly.',
    'bootstrap.lifecycle.ready': 'Lifecycle demo: app ready.',
    'bootstrap.lifecycle.deepLink.executed': 'Lifecycle demo deep link executed.',
    ...
    'menus.preferences.title': 'Preferences',
    'menus.preferences.entry.text': 'Preferences',
    'menus.preferences.entry.subText': 'Open a nested submenu example.',
    'menus.preferences.home.text': 'Home Preferences',
    'menus.preferences.home.subText': 'Open a nested submenu leaf item.',
    ...
    'pages.orders.trigger.headers.name': 'Name',
    'pages.orders.trigger.headers.description': 'Description',
    'pages.orders.trigger.headers.status': 'Status',
    'pages.orders.form.fields.administrators.label': 'Administrators',
    'pages.orders.form.fields.administrators.placeholder': 'Search for an administrator',
    'pages.orders.form.fields.administrators.hint': 'Select a person, press +, then select table rows to remove them.',
    'pages.orders.form.fields.administrators.add': 'Add',
    'pages.orders.form.fields.administrators.selected': 'Selected administrators ({count})',
    'pages.orders.form.fields.administrators.remove': 'Remove selected administrators',
    'pages.orders.form.fields.administrators.headers.name': 'Display name',
    'pages.orders.form.fields.administrators.headers.code': 'User code',
    'pages.orders.form.fields.administrators.headers.role': 'Role',
    ...
    'pages.people.report.tools.title': 'People Tools',
    'pages.people.report.tools.summary.text': 'Show Summary',
    'pages.people.report.tools.summary.subText': 'Open a report-level contextual action.',
    'pages.people.forms.step2.tools.title': 'Contact Step Tools',
    'pages.people.forms.step2.tools.review.text': 'Review Step 2',
    'pages.people.forms.step2.tools.review.subText': 'Form-level tools override the report tools while this step is active.',
    'pages.people.forms.step2.tools.review.success': 'Step 2 contextual tools are active.',
  ...
  de: {
    ...
    'bootstrap.sideNav.tools.title': 'Arbeitsbereichswerkzeuge',
    'bootstrap.sideNav.tools.theme.text': 'Thema wechseln',
    'bootstrap.sideNav.tools.language.text': 'Sprache wechseln',
    'bootstrap.sideNav.tools.language.subText': 'Die Demo-Sprache sofort umschalten.',
    'bootstrap.lifecycle.ready': 'Lebenszyklus-Demo: App ist bereit.',
    'bootstrap.lifecycle.deepLink.executed': 'Lebenszyklus-Demo-Deep-Link wurde ausgefuehrt.',
    ...
    'menus.preferences.title': 'Voreinstellungen',
    'menus.preferences.entry.text': 'Voreinstellungen',
    'menus.preferences.entry.subText': 'Ein Beispiel fuer ein verschachteltes Untermenue oeffnen.',
    'menus.preferences.home.text': 'Start-Voreinstellungen',
    'menus.preferences.home.subText': 'Ein Blatt-Element eines verschachtelten Untermenues oeffnen.',
    ...
    'pages.orders.trigger.headers.name': 'Name',
    'pages.orders.trigger.headers.description': 'Beschreibung',
    'pages.orders.trigger.headers.status': 'Status',
    'pages.orders.form.fields.administrators.label': 'Administratoren',
    'pages.orders.form.fields.administrators.placeholder': 'Nach einem Administrator suchen',
    'pages.orders.form.fields.administrators.hint': 'Eine Person auswaehlen, + druecken und Tabellenzeilen zum Entfernen markieren.',
    'pages.orders.form.fields.administrators.add': 'Hinzufuegen',
    'pages.orders.form.fields.administrators.selected': 'Ausgewaehlte Administratoren ({count})',
    'pages.orders.form.fields.administrators.remove': 'Ausgewaehlte Administratoren entfernen',
    'pages.orders.form.fields.administrators.headers.name': 'Anzeigename',
    'pages.orders.form.fields.administrators.headers.code': 'Benutzercode',
    'pages.orders.form.fields.administrators.headers.role': 'Rolle',
    ...
    'pages.people.report.tools.title': 'Personenwerkzeuge',
    'pages.people.report.tools.summary.text': 'Zusammenfassung anzeigen',
    'pages.people.report.tools.summary.subText': 'Eine berichtsbezogene Kontextaktion oeffnen.',
    'pages.people.forms.step2.tools.title': 'Werkzeuge fuer Kontaktschritt',
    'pages.people.forms.step2.tools.review.text': 'Schritt 2 pruefen',
    'pages.people.forms.step2.tools.review.subText': 'Formularwerkzeuge ueberschreiben die Berichtswerkzeuge waehrend dieser Schritt aktiv ist.',
    'pages.people.forms.step2.tools.review.success': 'Die Kontextwerkzeuge fuer Schritt 2 sind aktiv.',
